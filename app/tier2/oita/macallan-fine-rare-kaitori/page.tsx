    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>「大分県でマッカラン ファイン&レアを売りたい」という方のためのガイドです。大分県は九州地方の中核（人口115万人、大分・別府・中津・佐伯が主要都市）で、ウイスキー専門業者・大手総合業者の両方が出張・店頭・宅配で対応しています。</p>
          ...
          <h2>4. 大分県でマッカラン ファイン&レアを売る — 業者の選び方と査定取得先</h2>
