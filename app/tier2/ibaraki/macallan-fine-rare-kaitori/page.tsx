    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>「茨城県でマッカラン ファイン&レアを売りたい」という方のためのガイドです。茨城県は関東地方の中核（人口290万人、水戸・つくば・日立・土浦が主要都市）で、ウイスキー専門業者・大手総合業者の両方が出張・店頭・宅配で対応しています。</p>
          ...
          <h2>4. 茨城県でマッカラン ファイン&レアを売る — 業者の選び方と査定取得先</h2>
