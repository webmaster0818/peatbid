...
function Schema() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"\u5bae\u57ce\u5ce1\u30ce\u30f3\u30a8\u30a4\u30b8\u5e02\u5834\u76f8\u5834\u3068\u696d\u8005\u6bd4\u8f03\u3010\u9999\u5ddd\u770c\u6700\u65b0\u7248\u3011\", \"datePublished\": \"2026-05-19\", \"dateModified\": \"2026-05-25\", \"author\": {\"@type\": \"Organization\", \"name\": \"PeatBid\u7de8\u96c6\u90e8\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"PeatBid\"}}" }} />
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h2>4. 香川県で宮城峡ノンエイジを売る — 業者の選び方と査定取得先</h2>
