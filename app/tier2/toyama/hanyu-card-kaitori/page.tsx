...
function Schema() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"\u5bcc\u5c71\u770c\u3067\u7fbd\u751f\u30ab\u30fc\u30c9\u30b7\u30ea\u30fc\u30ba\u3092\u58f2\u5374\u30fb\u67fb\u5b9a\u3059\u308b\u5b8c\u5168\u30ac\u30a4\u30c9\", \"datePublished\": \"2026-05-19\", \"dateModified\": \"2026-05-25\", \"author\": {\"@type\": \"Organization\", \"name\": \"PeatBid\u7de8\u96c6\u90e8\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"PeatBid\"}}" }} />
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">富山県で羽生カードシリーズを売却・査定する完全ガイド</h1>
          ...
          <p>富山県（人口105万人、主要都市: 富山・高岡・砺波・射水）で羽生カードシリーズを売却したい方へ。本ページでは、富山県における羽生カードシリーズの **市場相場（Yahoo中央値）**・地元対応業者・複数業者で比較する手順を解説します。</p>
          ...
          <h2>4. 富山県で羽生カードシリーズを売る — 業者の選び方と査定取得先</h2>
