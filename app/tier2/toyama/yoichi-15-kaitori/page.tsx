...
export const metadata: Metadata = {
  title: "【2026年最新】富山県で余市15年を売る｜市場相場(Yahoo中央値)¥75,175・業者比較",
  description: "富山県（富山・高岡・砺波・射水）で余市15年を売却するなら？市場相場 ¥75,175（Yahoo Auctions 過去180日中央値）、中部地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">余市15年を富山県で売る — 業者選びと相見積もりのコツ</h1>
          ...
          <p>「富山県で余市15年を売りたい」という方のためのガイドです。富山県は中部地方の中核（人口105万人、富山・高岡・砺波・射水が主要都市）で、ウイスキー専門業者・大手総合業者の両方が出張・店頭・宅配で対応しています。</p>
          ...
          <p>富山県で余市15年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
