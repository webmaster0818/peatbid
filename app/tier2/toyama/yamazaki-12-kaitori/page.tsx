...
export const metadata: Metadata = {
  title: "【2026年最新】富山県で山崎12年を売る｜市場相場(Yahoo中央値)¥20,900・業者比較",
  description: "富山県（富山・高岡・砺波・射水）で山崎12年を売却するなら？市場相場 ¥20,900（Yahoo Auctions 過去180日中央値）、中部地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>富山県で山崎12年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
