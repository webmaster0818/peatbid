    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>「岐阜県で響21年を売りたい」という方のためのガイドです。岐阜県は中部地方の中核（人口200万人、岐阜・大垣・各務原・羽島が主要都市）で、ウイスキー専門業者・大手総合業者の両方が出張・店頭・宅配で対応しています。</p>
          ...
          <h2>4. 岐阜県で響21年を売る — 業者の選び方と査定取得先</h2>
