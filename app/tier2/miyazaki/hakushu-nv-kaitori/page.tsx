...
export const metadata: Metadata = {
  title: "【2026年最新】宮崎県で白州ノンエイジを売る｜市場相場(Yahoo中央値)¥10,000・業者比較",
  description: "宮崎県（宮崎・都城・延岡・日向）で白州ノンエイジを売却するなら？市場相場 ¥10,000（Yahoo Auctions 過去180日中央値）、九州地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">宮崎県の白州ノンエイジ市場相場と業者比較</h1>
          ...
          <p>白州ノンエイジを宮崎県で査定に出したい方のためのガイドです。宮崎県には108万人が暮らし、主要都市は宮崎・都城・延岡・日向。九州地方を代表する経済圏で、ウイスキー買取の需要も活発です。</p>
          ...
          <p>宮崎県で白州ノンエイジを売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
