...
function Schema() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"\u9ad8\u77e5\u770c\u3067\u7af9\u9db4\u30d4\u30e5\u30a2\u30e2\u30eb\u30c8\u3092\u58f2\u5374\u30fb\u67fb\u5b9a\u3059\u308b\u5b8c\u5168\u30ac\u30a4\u30c9\", \"datePublished\": \"2026-05-19\", \"dateModified\": \"2026-05-25\", \"author\": {\"@type\": \"Organization\", \"name\": \"PeatBid\u7de8\u96c6\u90e8\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"PeatBid\"}}" }} />
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">高知県で竹鶴ピュアモルトを売却・査定する完全ガイド</h1>
          ...
          <p>高知県（人口68万人、主要都市: 高知・南国・四万十・香南）で竹鶴ピュアモルトを売却したい方へ。本ページでは、高知県における竹鶴ピュアモルトの **市場相場（Yahoo中央値）**・地元対応業者・複数業者で比較する手順を解説します。</p>
          ...
          <h2>4. 高知県で竹鶴ピュアモルトを売る — 業者の選び方と査定取得先</h2>
          ...
          <h2>5. 高知県で竹鶴ピュアモルトを高く売る5つのコツ</h2>
          <ol>
