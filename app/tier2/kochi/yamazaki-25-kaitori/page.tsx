    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>「高知県で山崎25年を売りたい」という方のためのガイドです。高知県は四国地方の中核（人口68万人、高知・南国・四万十・香南が主要都市）で、ウイスキー専門業者・大手総合業者の両方が出張・店頭・宅配で対応しています。</p>
          ...
          <h2>4. 高知県で山崎25年を売る — 業者の選び方と査定取得先</h2>
