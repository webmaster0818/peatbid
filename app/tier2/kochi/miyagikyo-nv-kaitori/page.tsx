...
function Schema() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"\u9ad8\u77e5\u770c\u3067\u5bae\u57ce\u5ce1\u30ce\u30f3\u30a8\u30a4\u30b8\u3092\u58f2\u5374\u30fb\u67fb\u5b9a\u3059\u308b\u5b8c\u5168\u30ac\u30a4\u30c9\", \"datePublished\": \"2026-05-19\", \"dateModified\": \"2026-05-25\", \"author\": {\"@type\": \"Organization\", \"name\": \"PeatBid\u7de8\u96c6\u90e8\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"PeatBid\"}}" }} />
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h2>4. 高知県で宮城峡ノンエイジを売る — 業者の選び方と査定取得先</h2>
