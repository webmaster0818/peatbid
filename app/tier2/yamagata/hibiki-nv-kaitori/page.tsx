...
export const metadata: Metadata = {
  title: "【2026年最新】山形県で響ジャパニーズハーモニーを売る｜市場相場(Yahoo中央値)¥11,110・業者比較",
  description: "山形県（山形・米沢・天童・酒田）で響ジャパニーズハーモニーを売却するなら？市場相場 ¥11,110（Yahoo Auctions 過去180日中央値）、東北地方の地元業者と4業者参考リンクを掲載。",
