...
function Schema() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"\u5bae\u57ce\u5ce115\u5e74\u5e02\u5834\u76f8\u5834\u3068\u696d\u8005\u6bd4\u8f03\u3010\u5c71\u5f62\u770c\u6700\u65b0\u7248\u3011\", \"datePublished\": \"2026-05-19\", \"dateModified\": \"2026-05-25\", \"author\": {\"@type\": \"Organization\", \"name\": \"PeatBid\u7de8\u96c6\u90e8\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"PeatBid\"}}" }} />
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">宮城峡15年市場相場と業者比較【山形県最新版】</h1>
          ...
          <p>本ページは山形県における宮城峡15年の業者査定ガイドです。市場相場は Yahoo Auctions 過去180日の落札データ中央値（実勢データ）を使用し、業者買取額は4業者の公式ページへ直リンクして比較できる構成です。</p>
          ...
          <h2>4. 山形県で宮城峡15年を売る — 業者の選び方と査定取得先</h2>
