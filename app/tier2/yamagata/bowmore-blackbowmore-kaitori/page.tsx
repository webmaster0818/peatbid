...
export const metadata: Metadata = {
  title: "【2026年最新】山形県でブラックボウモアを売る｜業者比較・買取査定ガイド",
  description: "山形県（山形・米沢・天童・酒田）でブラックボウモアを売却するなら？東北地方の地元業者と4業者参考リンクを掲載。市場相場は現在データ蓄積中で、確定額は各業者の最新査定でご確認ください。",
