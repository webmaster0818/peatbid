...
export const metadata: Metadata = {
  title: "【2026年最新】福岡県でマルス駒ヶ岳を売る｜市場相場(Yahoo中央値)¥7,975・業者比較",
  description: "福岡県（博多・天神・小倉・久留米・北九州）でマルス駒ヶ岳を売却するなら？市場相場 ¥7,975（Yahoo Auctions 過去180日中央値）、九州地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">福岡県のマルス駒ヶ岳市場相場と業者比較</h1>
          ...
          <p>マルス駒ヶ岳を福岡県で査定に出したい方のためのガイドです。福岡県には510万人が暮らし、主要都市は博多・天神・小倉・久留米・北九州。九州地方を代表する経済圏で、ウイスキー買取の需要も活発です。</p>
          ...
          <p>福岡県でマルス駒ヶ岳を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
