...
export const metadata: Metadata = {
  title: "【2026年最新】岡山県で響21年を売る｜市場相場(Yahoo中央値)¥71,003・業者比較",
  description: "岡山県（岡山・倉敷・津山・玉野）で響21年を売却するなら？市場相場 ¥71,003（Yahoo Auctions 過去180日中央値）、中国地方の地元業者と4業者参考リンクを掲載。",
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div className="not-prose my-8">
            ...
            <p className="text-sm text-warm-gray mb-3">岡山県の近隣エリアでも響21年の買取相場を比較できます。</p>
