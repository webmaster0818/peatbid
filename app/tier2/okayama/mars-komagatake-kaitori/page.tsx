...
export const metadata: Metadata = {
  title: "【2026年最新】岡山県でマルス駒ヶ岳を売る｜市場相場(Yahoo中央値)¥8,500・業者比較",
  description: "岡山県（岡山・倉敷・津山・玉野）でマルス駒ヶ岳を売却するなら？市場相場 ¥8,500（Yahoo Auctions 過去180日中央値）、中国地方の地元業者と4業者参考リンクを掲載。",
