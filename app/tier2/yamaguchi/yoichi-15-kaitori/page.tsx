...
export const metadata: Metadata = {
  title: "【2026年最新】山口県で余市15年を売る｜市場相場(Yahoo中央値)¥75,175・業者比較",
  description: "山口県（山口・下関・宇部・周南）で余市15年を売却するなら？市場相場 ¥75,175（Yahoo Auctions 過去180日中央値）、中国地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>余市15年を山口県で査定に出したい方のためのガイドです。山口県には130万人が暮らし、主要都市は山口・下関・宇部・周南。中国地方を代表する経済圏で、ウイスキー買取の需要も活発です。</p>
          ...
          <p>山口県で余市15年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
