...
export const metadata: Metadata = {
  title: "【2026年最新】三重県で余市15年を売る｜市場相場(Yahoo中央値)¥75,175・業者比較",
  description: "三重県（津・四日市・松阪・伊勢）で余市15年を売却するなら？市場相場 ¥75,175（Yahoo Auctions 過去180日中央値）、関西地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>三重県（人口175万人、主要都市: 津・四日市・松阪・伊勢）で余市15年を売却したい方へ。本ページでは、三重県における余市15年の **市場相場（Yahoo中央値）**・地元対応業者・複数業者で比較する手順を解説します。</p>
          ...
          <p>三重県で余市15年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
