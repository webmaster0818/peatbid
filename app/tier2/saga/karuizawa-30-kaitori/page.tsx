...
export const metadata: Metadata = {
  title: "【2026年最新】佐賀県で軽井沢30年を売る｜市場相場(Yahoo中央値)市場相場データ蓄積中・業者比較",
  description: "佐賀県（佐賀・唐津・鳥栖・伊万里）で軽井沢30年を売却するなら？市場相場 市場相場データ蓄積中（Yahoo Auctions 過去180日中央値）、九州地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>佐賀県で軽井沢30年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
