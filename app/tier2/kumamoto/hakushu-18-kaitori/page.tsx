...
export const metadata: Metadata = {
  title: "【2026年最新】熊本県で白州18年を売る｜市場相場(Yahoo中央値)¥69,400・業者比較",
  description: "熊本県（熊本・八代・天草・荒尾）で白州18年を売却するなら？市場相場 ¥69,400（Yahoo Auctions 過去180日中央値）、九州地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>本ページは熊本県における白州18年の業者査定ガイドです。市場相場は Yahoo Auctions 過去180日の落札データ中央値（実勢データ）を使用し、業者買取額は4業者の公式ページへ直リンクして比較できる構成です。</p>
          ...
          <p>熊本県で白州18年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
