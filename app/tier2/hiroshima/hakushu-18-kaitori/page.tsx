...
export const metadata: Metadata = {
  title: "【2026年最新】広島県で白州18年を売る｜市場相場(Yahoo中央値)¥69,400・業者比較",
  description: "広島県（広島・福山・東広島・呉）で白州18年を売却するなら？市場相場 ¥69,400（Yahoo Auctions 過去180日中央値）、中国地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">広島県エリア対応の白州18年買取ガイド</h1>
          ...
          <p>白州18年の買取を広島県で検討中の方へ。275万人が居住する広島県（広島・福山・東広島・呉）には、地域密着業者と全国大手の両方が対応しており、相見積もりで高値が出やすい環境です。本ページでは Yahoo中央値ベースの市場相場と、4業者への参考リンクを掲載しています。</p>
          ...
          <p>広島県で白州18年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
