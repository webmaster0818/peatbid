    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>「広島県でスプリングバンク21年を売りたい」という方のためのガイドです。広島県は中国地方の中核（人口275万人、広島・福山・東広島・呉が主要都市）で、ウイスキー専門業者・大手総合業者の両方が出張・店頭・宅配で対応しています。</p>
          ...
          <h2>4. 広島県でスプリングバンク21年を売る — 業者の選び方と査定取得先</h2>
