    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>「京都府で余市ノンエイジを売りたい」という方のためのガイドです。京都府は関西地方の中核（人口260万人、四条・河原町・烏丸・京都駅周辺・祇園が主要都市）で、ウイスキー専門業者・大手総合業者の両方が出張・店頭・宅配で対応しています。</p>
          ...
          <h2>4. 京都府で余市ノンエイジを売る — 業者の選び方と査定取得先</h2>
