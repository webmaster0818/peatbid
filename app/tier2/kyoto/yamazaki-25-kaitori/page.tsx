...
export const metadata: Metadata = {
  title: "【2026年最新】京都府で山崎25年を売る｜市場相場(Yahoo中央値)¥75,000・業者比較",
  description: "京都府（四条・河原町・烏丸・京都駅周辺・祇園）で山崎25年を売却するなら？市場相場 ¥75,000（Yahoo Auctions 過去180日中央値）、関西地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>京都府で山崎25年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
