...
export const metadata: Metadata = {
  title: "【2026年最新】京都府で山崎25年を売る｜市場相場(Yahoo中央値)¥29,150・業者比較",
  description: "京都府（四条・河原町・烏丸・京都駅周辺・祇園）で山崎25年を売却するなら？市場相場 ¥29,150（Yahoo Auctions 過去180日中央値）、関西地方の地元業者と4業者参考リンクを掲載。",
