...
export const metadata: Metadata = {
  title: "【2026年最新】京都府で竹鶴17年を売る｜市場相場(Yahoo中央値)¥32,998・業者比較",
  description: "京都府（四条・河原町・烏丸・京都駅周辺・祇園）で竹鶴17年を売却するなら？市場相場 ¥32,998（Yahoo Auctions 過去180日中央値）、関西地方の地元業者と4業者参考リンクを掲載。",
