...
function Schema() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"\u4eac\u90fd\u5e9c\u306e\u30a4\u30c1\u30ed\u30fc\u30ba\u30e2\u30eb\u30c8 \u30c0\u30d6\u30eb\u30c7\u30a3\u30b9\u30c6\u30a3\u30e9\u30ea\u30fc\u30ba\u5e02\u5834\u76f8\u5834\u3068\u696d\u8005\u6bd4\u8f03\", \"datePublished\": \"2026-05-19\", \"dateModified\": \"2026-05-25\", \"author\": {\"@type\": \"Organization\", \"name\": \"PeatBid\u7de8\u96c6\u90e8\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"PeatBid\"}}" }} />
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">京都府のイチローズモルト ダブルディスティラリーズ市場相場と業者比較</h1>
          ...
          <p>イチローズモルト ダブルディスティラリーズを京都府で査定に出したい方のためのガイドです。京都府には260万人が暮らし、主要都市は四条・河原町・烏丸・京都駅周辺・祇園。関西地方を代表する経済圏で、ウイスキー買取の需要も活発です。</p>
          ...
          <h2>4. 京都府でイチローズモルト ダブルディスティラリーズを売る — 業者の選び方と査定取得先</h2>
          <p>京都府でイチローズモルト ダブルディスティラリーズを売却する際の業者は大きく2タイプに分かれます。最高値を引き出すには、両方から相見積もりを取るのが鉄則です。</p>

          <h3 className="!mt-6">4-1. 京都府の地元・対応買取業者</h3>
