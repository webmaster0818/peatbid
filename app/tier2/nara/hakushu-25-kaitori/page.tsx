...
function Schema() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: "{\"@context\": \"https://schema.org\", \"@type\": \"Article\", \"headline\": \"\u767d\u5dde25\u5e74\u3092\u5948\u826f\u770c\u3067\u58f2\u308b \u2014 \u696d\u8005\u9078\u3073\u3068\u76f8\u898b\u7a4d\u3082\u308a\u306e\u30b3\u30c4\", \"datePublished\": \"2026-05-19\", \"dateModified\": \"2026-05-25\", \"author\": {\"@type\": \"Organization\", \"name\": \"PeatBid\u7de8\u96c6\u90e8\"}, \"publisher\": {\"@type\": \"Organization\", \"name\": \"PeatBid\"}}" }} />
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">白州25年を奈良県で売る — 業者選びと相見積もりのコツ</h1>
          ...
          <p>「奈良県で白州25年を売りたい」という方のためのガイドです。奈良県は関西地方の中核（人口130万人、奈良・橿原・生駒・大和郡山が主要都市）で、ウイスキー専門業者・大手総合業者の両方が出張・店頭・宅配で対応しています。</p>
          ...
          <h2>4. 奈良県で白州25年を売る — 業者の選び方と査定取得先</h2>
