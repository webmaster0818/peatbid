...
export const metadata: Metadata = {
  title: "【2026年最新】長崎県で余市15年を売る｜市場相場(Yahoo中央値)¥75,175・業者比較",
  description: "長崎県（長崎・佐世保・諫早・大村）で余市15年を売却するなら？市場相場 ¥75,175（Yahoo Auctions 過去180日中央値）、九州地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>余市15年を長崎県で査定に出したい方のためのガイドです。長崎県には130万人が暮らし、主要都市は長崎・佐世保・諫早・大村。九州地方を代表する経済圏で、ウイスキー買取の需要も活発です。</p>
          ...
          <p>長崎県で余市15年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
