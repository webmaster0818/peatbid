...
export const metadata: Metadata = {
  title: "【2026年最新】鳥取県で白州18年を売る｜市場相場(Yahoo中央値)¥69,400・業者比較",
  description: "鳥取県（鳥取・米子・倉吉・境港）で白州18年を売却するなら？市場相場 ¥69,400（Yahoo Auctions 過去180日中央値）、中国地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>鳥取県（人口55万人、主要都市: 鳥取・米子・倉吉・境港）で白州18年を売却したい方へ。本ページでは、鳥取県における白州18年の **市場相場（Yahoo中央値）**・地元対応業者・複数業者で比較する手順を解説します。</p>
          ...
          <p>鳥取県で白州18年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
