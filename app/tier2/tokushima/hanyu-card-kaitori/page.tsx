...
export const metadata: Metadata = {
  title: "【2026年最新】徳島県で羽生カードシリーズを売る｜市場相場(Yahoo中央値)¥7,000・業者比較",
  description: "徳島県（徳島・鳴門・阿南・吉野川）で羽生カードシリーズを売却するなら？市場相場 ¥7,000（Yahoo Auctions 過去180日中央値）、四国地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>徳島県で羽生カードシリーズを売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
          ...
          <h2>6. 徳島県で羽生カードシリーズを高く売る5つのコツ</h2>
          <ol>
          ...
          <h2>7. 徳島県の羽生カードシリーズ買取で注意すべき点</h2>
          <ul>
