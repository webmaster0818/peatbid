...
export const metadata: Metadata = {
  title: "【2026年最新】滋賀県で余市15年を売る｜市場相場(Yahoo中央値)¥75,175・業者比較",
  description: "滋賀県（大津・草津・彦根・近江八幡）で余市15年を売却するなら？市場相場 ¥75,175（Yahoo Auctions 過去180日中央値）、関西地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">滋賀県の余市15年市場相場と業者比較</h1>
          ...
          <p>余市15年を滋賀県で査定に出したい方のためのガイドです。滋賀県には140万人が暮らし、主要都市は大津・草津・彦根・近江八幡。関西地方を代表する経済圏で、ウイスキー買取の需要も活発です。</p>
          ...
          <p>滋賀県で余市15年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
