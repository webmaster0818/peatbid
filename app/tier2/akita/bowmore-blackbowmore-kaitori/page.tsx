...
export const metadata: Metadata = {
  title: "【2026年最新】秋田県でブラックボウモアを売る｜業者比較・買取査定ガイド",
  description: "秋田県（秋田・横手・大仙・能代）でブラックボウモアを売却するなら？東北地方の地元業者と4業者参考リンクを掲載。市場相場は現在データ蓄積中で、確定額は各業者の最新査定でご確認ください。",
