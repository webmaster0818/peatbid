...
export const metadata: Metadata = {
  title: "【2026年最新】秋田県でアードベッグ コリーヴレッカンを売る｜市場相場(Yahoo中央値)¥8,030・業者比較",
  description: "秋田県（秋田・横手・大仙・能代）でアードベッグ コリーヴレッカンを売却するなら？市場相場 ¥8,030（Yahoo Auctions 過去180日中央値）、東北地方の地元業者と4業者参考リンクを掲載。",
