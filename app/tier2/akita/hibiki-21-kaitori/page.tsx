...
export const metadata: Metadata = {
  title: "【2026年最新】秋田県で響21年を売る｜市場相場(Yahoo中央値)¥71,001・業者比較",
  description: "秋田県（秋田・横手・大仙・能代）で響21年を売却するなら？市場相場 ¥71,001（Yahoo Auctions 過去180日中央値）、東北地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">秋田県の響21年市場相場と業者比較</h1>
          ...
          <p>響21年を秋田県で査定に出したい方のためのガイドです。秋田県には95万人が暮らし、主要都市は秋田・横手・大仙・能代。東北地方を代表する経済圏で、ウイスキー買取の需要も活発です。</p>
          ...
          <p>秋田県で響21年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
