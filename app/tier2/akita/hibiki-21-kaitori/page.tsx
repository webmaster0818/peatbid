...
export const metadata: Metadata = {
  title: "【2026年最新】秋田県で響21年を売る｜市場相場(Yahoo中央値)¥71,685・業者比較",
  description: "秋田県（秋田・横手・大仙・能代）で響21年を売却するなら？市場相場 ¥71,685（Yahoo Auctions 過去180日中央値）、東北地方の地元業者と4業者参考リンクを掲載。",
