...
export const metadata: Metadata = {
  title: "【2026年最新】秋田県で山崎18年を売る｜市場相場(Yahoo中央値)¥93,001・業者比較",
  description: "秋田県（秋田・横手・大仙・能代）で山崎18年を売却するなら？市場相場 ¥93,001（Yahoo Auctions 過去180日中央値）、東北地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>秋田県で山崎18年を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
