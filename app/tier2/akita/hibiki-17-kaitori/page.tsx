...
export const metadata: Metadata = {
  title: "【2026年最新】秋田県で響17年を売る｜市場相場(Yahoo中央値)¥47,999・業者比較",
  description: "秋田県（秋田・横手・大仙・能代）で響17年を売却するなら？市場相場 ¥47,999（Yahoo Auctions 過去180日中央値）、東北地方の地元業者と4業者参考リンクを掲載。",
