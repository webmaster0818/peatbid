...
export const metadata: Metadata = {
  title: "【2026年最新】鹿児島県でマルス駒ヶ岳を売る｜市場相場(Yahoo中央値)¥7,975・業者比較",
  description: "鹿児島県（鹿児島・霧島・薩摩川内・鹿屋）でマルス駒ヶ岳を売却するなら？市場相場 ¥7,975（Yahoo Auctions 過去180日中央値）、九州地方の地元業者と4業者参考リンクを掲載。",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>「鹿児島県でマルス駒ヶ岳を売りたい」という方のためのガイドです。鹿児島県は九州地方の中核（人口157万人、鹿児島・霧島・薩摩川内・鹿屋が主要都市）で、ウイスキー専門業者・大手総合業者の両方が出張・店頭・宅配で対応しています。</p>
          ...
          <p>鹿児島県でマルス駒ヶ岳を売却する際の主要業者を紹介します。地域密着の専門業者から全国対応の大手まで、状況に合わせて選びましょう。</p>
          <div className="table-wrapper">
            <table>
