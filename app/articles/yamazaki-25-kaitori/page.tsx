    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt="山崎25年の買取相場" width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">山崎25年の買取相場と高く売る完全ガイド</h1>
          ...
          <p>2026年5月現在、山崎25年（未開封・箱付き）の買取相場は<strong>約880,000円前後</strong>。希少度は<strong>ウルトラ</strong>クラスに位置し、極めて希少な長期熟成銘柄。Sotheby's・Bonhamsなどの海外オークションでの落札データが査定の基準となり、富裕層・コレクターの主要ターゲット。</p>
          ...
          <div className="table-wrapper">
            <table>
              <tbody>
                ...
                <tr><td><strong>参考買取価格（未開封・箱付き）</strong></td><td><strong>880,000円前後</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>2026年5月時点での山崎25年の買取相場は<strong>748,000円〜880,000円</strong>のレンジで推移しています（未開封・箱付きの場合）。この相場は、以下の市場データの集約から算出しています:</p>
          ...
          <p>山崎25年の査定額は、ボトルの状態と付属品の有無により大きく変動します。以下のビジュアルガイドで、5段階の主要状態を確認してください:</p>
          ...
          <div className="table-wrapper">
            <table>
              ...
              <tbody>
                <tr><td>未開封・完璧</td><td>箱・冊子・カートン揃い</td><td><strong>836,000円〜880,000円</strong></td></tr>
                <tr><td>未開封・箱なし</td><td>ラベル良好</td><td><strong>704,000円〜792,000円</strong></td></tr>
                <tr><td>未開封・冊子なし</td><td>外箱あり</td><td><strong>748,000円〜836,000円</strong></td></tr>
                <tr><td>未開封・ラベル軽度汚れ</td><td>付属あり</td><td><strong>660,000円〜774,400円</strong></td></tr>
                <tr><td>未開封・ラベル損傷</td><td>付属あり</td><td><strong>528,000円〜660,000円</strong></td></tr>
                <tr><td>未開封・液面減少</td><td>やや進行</td><td><strong>484,000円〜616,000円</strong></td></tr>
                <tr><td>開封済み・9割以上残</td><td>付属あり</td><td><strong>264,000円〜352,000円</strong></td></tr>
                <tr><td>開封済み・半分以下残</td><td>付属あり</td><td><strong>132,000円〜220,000円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>880,000円クラスの高額銘柄では、贋作・偽造ボトルのリスクが存在します。本物を見抜くには以下の5つのチェックが有効です:</p>
