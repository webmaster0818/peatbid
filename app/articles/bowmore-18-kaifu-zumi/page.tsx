...
export const metadata: Metadata = {
  title: 'ボウモア18年は開封済みでも売れる?【2026年8月最新】残量別の買取査定額と売却法',
  description: 'ボウモア18年を開封済みで売る場合の査定額と注意点。残量別の価格目安、状態保持のコツ、開封済み歓迎の買取業者、売却前の準備まで完全解説。',
};
...
export default function Bowmore18KaifuZumiPage() {
  return (
    <>
      <FaqSchema />
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/bowmore-18.png" alt='ボウモア18年が開封済みでも売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">ボウモア18年が開封済みでも売れる？</h1>
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-1" className="hover:underline">2. 開封済みボウモア18年の査定額の目安</a></li>
          ...
          <p>「ボウモア18年を開けてしまった……もう売れない？」と諦めている方、ご安心ください。開封済みでも、状態と残量次第で買取は可能です。本記事では、開封済みのボウモア18年を最大限の価格で売る方法を完全解説します。</p>
          ...
          <h2 id="section-1">2. 開封済みボウモア18年の査定額の目安</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きの実勢中央値<strong>10,834円</strong>を基準として、開封済みは残量・状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 約3,250〜4,330円（30〜40%）</li><li><strong>7割以上残</strong>: 約2,710〜3,790円（25〜35%）</li><li><strong>5割以上残</strong>: 約2,170〜3,250円（20〜30%）</li><li><strong>3割以上残</strong>: 約1,080〜2,170円（10〜20%）</li><li><strong>1割以下残</strong>: 買取不可の場合あり、もしくは空ボトルとして数千円
