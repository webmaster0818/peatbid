...
export const metadata: Metadata = {
  title: 'グレンファークラス25年が箱なしでも買取できる？【2026年完全版】査定額への影響と代替戦略',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>グレンファークラス25年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 30,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 25,500円〜28,500円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 25,500円〜27,600円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 24,000円〜27,000円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 22,500円〜25,500円（75〜85%）

つまり、最大で<strong>約25%（7,500円）の差</strong>が生じる可能性があります。</li></ol>` }} />
