    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/glenfarclas-25.png" alt='グレンファークラス25年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>グレンファークラス25年の場合、実勢中央値<strong>23,593円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 23,593円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約20,050〜22,410円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約20,050〜21,710円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約18,870〜21,230円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約17,690〜20,050円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約5,900円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
...
本物の外箱が見つからない場合は、箱なしで正直に売却するのが正解です。</li></ol>` }} />
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>一部のコレクター・買取業者は、空き箱を単体で販売することがあります。<strong>入手経路</strong>:</p><ol><li><strong>メルカリ・ヤフオク</strong> — 「グレンファークラス25年 箱」で検索</li><li><strong>海外オークション</strong> — Whisky Auctioneerなどで稀に出品</li><li><strong>コレクターSNS</strong> — Twitter・Instagramで交換相手を探す</li><li><strong>ウイスキー専門店</strong> — 店舗に在庫がある場合あり
...
空き箱の価格は数千円〜数万円程度。査定額アップ幅と比較して、投資価値があるか判断してください。</li></ol>` }} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 not-prose">
            ...
            <Link href="/articles/glenfarclas-25-nisemono-mikata/" className="block bg-white border border-warm-border rounded-xl p-4 hover:shadow-md transition-shadow"><span className="text-xs text-amber-dark font-bold">売る前チェック（真贋と相場）</span><p className="text-sm font-bold mt-1">グレンファークラス25年の売る前チェック（真贋と相場）</p></Link>
