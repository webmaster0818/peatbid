    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>宮城峡蒸溜所はジャパニーズウイスキー業界で長い歴史を持つ蒸溜所。伝統的な製法と現代の品質管理を融合し、宮城峡12年を含む数々の名作を世に送り出しています。ジャパニーズウイスキーの場合は1923年の山崎蒸溜所創設以降、スコッチの場合は18〜19世紀に遡る歴史を持つ銘柄も多数あります。</p>

          <h2>宮城峡12年の味わいプロファイル</h2>

          <p>ウイスキーの味わいは、原料・水・蒸溜方法・熟成樽・熟成期間で決まります。宮城峡12年は12年熟成の熟成を経ており、その期間に樽の成分が酒に溶け込み、複雑な香味が形成されています。公式テイスティングノートやプロのレビューでも高く評価される一本です。</p>

          <h2>世界的評価と受賞歴</h2>

          <p>宮城峡12年を含む宮城峡蒸溜所の銘柄は、ISC（インターナショナル・スピリッツ・チャレンジ）やワールド・ウイスキー・アワード等の国際品評会で多数受賞しています。この国際的評価が、二次流通市場での高値を支えています。</p>

          <h2>二次流通市場での位置付け</h2>

          <p>Sotheby's、Bonhams、Whisky Auctioneer等の海外オークションで、宮城峡12年は定期的に取引されており、落札データが国内買取相場の指標となっています。終売や限定リリースの場合は、希少性プレミアが大きく乗ります。</p>

          <h2>コレクター・投資需要</h2>

          <p>宮城峡12年は飲用目的だけでなく、コレクション・投資対象としても保有されることが多い銘柄です。アジア富裕層・欧米コレクター・国内コレクターが市場参加者として三つ巴で需要を形成しています。</p>
