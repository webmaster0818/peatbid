...
export const metadata: Metadata = {
  title: 'マルス駒ヶ岳は箱なしでも買取できる?【2026年6月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マルス駒ヶ岳の場合、実勢中央値<strong>7,375円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 7,375円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約6,270〜7,010円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約6,270〜6,780円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約5,900〜6,640円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約5,530〜6,270円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約1,840円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
