...
export const metadata: Metadata = {
  title: 'マルス駒ヶ岳は箱なしでも買取できる?【2026年8月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マルス駒ヶ岳の場合、実勢中央値<strong>8,248円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 8,248円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約7,010〜7,840円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約7,010〜7,590円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約6,600〜7,420円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約6,190〜7,010円（75〜85%）
