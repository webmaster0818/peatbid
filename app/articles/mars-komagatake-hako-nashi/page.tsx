...
export const metadata: Metadata = {
  title: 'マルス駒ヶ岳が箱なしでも買取できる？【2026年完全版】査定額への影響と代替戦略',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マルス駒ヶ岳の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 12,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 10,200円〜11,400円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 10,200円〜11,040円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 9,600円〜10,800円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 9,000円〜10,200円（75〜85%）
