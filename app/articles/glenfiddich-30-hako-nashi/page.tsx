...
export const metadata: Metadata = {
  title: 'グレンフィディック30年が箱なしでも買取できる？【2026年完全版】査定額への影響と代替戦略',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>グレンフィディック30年の場合、実勢中央値<strong>70,205円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 70,205円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約59,670〜66,690円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約59,670〜64,590円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約56,160〜63,180円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約52,650〜59,670円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約17,550円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
