...
export const metadata: Metadata = {
  title: 'グレンモーレンジ シグネットの市場相場【2026年最新】20,500円・Yahoo中央値ベース完全ガイド',
