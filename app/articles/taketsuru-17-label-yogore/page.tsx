...
export const metadata: Metadata = {
  title: '竹鶴17年はラベル汚れ・破れでも売れる?【2026年8月最新】状態別の買取査定額',
        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-2" className="hover:underline">3. ラベル状態別の査定額目安（竹鶴17年）</a></li>
          ...
          <h2 id="section-2">3. ラベル状態別の査定額目安（竹鶴17年）</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴17年の実勢中央値<strong>32,998円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 32,998円（100%）</li><li><strong>軽度の汚れ</strong>: 約29,700円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約26,400円（80%程度）</li><li><strong>破れ・欠け</strong>: 約21,450円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約16,500円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約13,200円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約6,600円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
