...
export const metadata: Metadata = {
  title: 'マッカラン ファイン&レアのラベル汚れ・破れがあっても売れる？【2026年最新】状態別の査定額目安',
  description: 'マッカラン ファイン&レアのラベル汚れ・破れ・剥がれ・水濡れ跡がある場合の買取査定額を解説。状態別の価格目安と、ラベルを保護する保管方法。',
};
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>長期保管したマッカラン ファイン&レアのラベルが汚れた、破れた、水濡れ跡がついた——そんな場合でも、買取は可能です。本記事では、ラベルの状態が査定額にどう影響するか、状態別の価格目安を解説します。</p>
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン ファイン&レアの基準価格 500万円に対し、ラベル状態でこう変動します:<br/>- <strong>新品同様</strong>: 500万円（100%）<br/>- <strong>軽度の汚れ</strong>: 450万円（90%程度）<br/>- <strong>シミ・水濡れ跡</strong>: 400万円（80%程度）<br/>- <strong>破れ・欠け</strong>: 325万円（65%程度）<br/>- <strong>強い退色・大きな損傷</strong>: 250万円（50%程度）</p>` }} />
