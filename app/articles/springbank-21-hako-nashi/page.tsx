    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>スプリングバンク21年の場合、実勢中央値<strong>99,500円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 99,500円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約84,580〜94,520円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約84,580〜91,540円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約79,600〜89,550円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約74,620〜84,580円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約24,880円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
