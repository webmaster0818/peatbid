...
export const metadata: Metadata = {
  title: 'バルヴェニー ポートウッド 21年の市場相場ガイド【2026年最新】・Yahoo中央値ベース',
  description: 'バルヴェニー ポートウッド 21年（Balvenie Portwood 21 Year）の最新市場相場（Yahoo Auctions 過去180日落札中央値）。状態別の業界目安、業者比較リンク、蒸溜所の歴史、テイスティング、贋作リスクまで網羅。コレクター・オーナー必読の決定版ガイド。',
};
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">バルヴェニー ポートウッド 21年の市場相場と業者比較ガイド</h1>
