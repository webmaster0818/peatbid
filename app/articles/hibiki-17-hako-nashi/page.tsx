...
export const metadata: Metadata = {
  title: '響17年は箱なしでも買取できる?【2026年6月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響17年の場合、実勢中央値<strong>48,398円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 48,398円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約41,140〜45,980円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約41,140〜44,530円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約38,720〜43,560円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約36,300〜41,140円（75〜85%）
