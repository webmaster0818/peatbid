    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響17年の場合、実勢中央値<strong>47,658円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 47,658円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約40,510〜45,280円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約40,510〜43,850円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約38,130〜42,890円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約35,740〜40,510円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約11,910円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
