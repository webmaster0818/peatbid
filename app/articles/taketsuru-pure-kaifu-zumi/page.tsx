    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きの実勢中央値<strong>7,179円</strong>を基準として、開封済みは残量・状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 約2,150〜2,870円（30〜40%）</li><li><strong>7割以上残</strong>: 約1,790〜2,510円（25〜35%）</li><li><strong>5割以上残</strong>: 約1,440〜2,150円（20〜30%）</li><li><strong>3割以上残</strong>: 約720〜1,440円（10〜20%）</li><li><strong>1割以下残</strong>: 買取不可の場合あり、もしくは空ボトルとして数千円
