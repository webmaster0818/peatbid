    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きの実勢中央値<strong>5,775円</strong>を基準として、開封済みは残量・状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 約1,730〜2,310円（30〜40%）</li><li><strong>7割以上残</strong>: 約1,440〜2,020円（25〜35%）</li><li><strong>5割以上残</strong>: 約1,160〜1,730円（20〜30%）</li><li><strong>3割以上残</strong>: 約580〜1,160円（10〜20%）</li><li><strong>1割以下残</strong>: 買取不可の場合あり、もしくは空ボトルとして数千円
