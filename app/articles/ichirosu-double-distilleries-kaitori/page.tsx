    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div className="table-wrapper">
            <table>
              <tbody>
                ...
                <tr><td><strong>市場相場（Yahoo中央値）</strong></td><td><strong>10,998円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>イチローズモルト ダブルディスティラリーズの市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>10,998円</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=270件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="イチローズモルト ダブルディスティラリーズのヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,141.9 158.7,141.9 251.3,141.9 344.0,155.1 436.7,39.4 529.3,38.9 622.0,39.4" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="141.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-05-25: 10,780円（サンプル n=242件）</title></circle>
              <circle cx="158.7" cy="141.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-01: 10,780円（サンプル n=238件）</title></circle>
              <circle cx="251.3" cy="141.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-08: 10,780円（サンプル n=238件）</title></circle>
              <circle cx="344.0" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-15: 10,752円（サンプル n=236件）</title></circle>
              <circle cx="436.7" cy="39.4" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 10,998円（サンプル n=246件）</title></circle>
              <circle cx="529.3" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 10,999円（サンプル n=264件）</title></circle>
              <circle cx="622.0" cy="39.4" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 10,998円（サンプル n=270件）</title></circle>
              <text x="618.0" y="29.4" fontSize="11" fontWeight="bold" fill="#8A5A18" textAnchor="end">10,998円</text>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-05-25〜2026-07-06（週次7点・各点のサンプル数 n=236〜270件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
