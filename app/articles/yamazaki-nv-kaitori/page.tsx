...
export const metadata: Metadata = {
  title: '【毎週更新】山崎ノンエイジの買取相場｜ヤフオク落札中央値10,175円基準【2026年7月】',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">山崎ノンエイジの買取相場と業者比較ガイド【2026年7月】</h1>
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="山崎ノンエイジのヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,155.1 127.8,38.9 189.6,38.9 251.3,38.9 313.1,38.9 374.9,38.9 436.7,38.9 498.4,38.9 560.2,38.9 622.0,38.9" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-05-25: 10,161円（サンプル n=244件）</title></circle>
              <circle cx="127.8" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-01: 10,175円（サンプル n=250件）</title></circle>
              <circle cx="189.6" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-08: 10,175円（サンプル n=248件）</title></circle>
              <circle cx="251.3" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-15: 10,175円（サンプル n=252件）</title></circle>
              <circle cx="313.1" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 10,175円（サンプル n=248件）</title></circle>
              <circle cx="374.9" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 10,175円（サンプル n=252件）</title></circle>
              <circle cx="436.7" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 10,175円（サンプル n=258件）</title></circle>
              <circle cx="498.4" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 10,175円（サンプル n=258件）</title></circle>
              <circle cx="560.2" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-20: 10,175円（サンプル n=258件）</title></circle>
              <circle cx="622.0" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-27: 10,175円（サンプル n=262件）</title></circle>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-05-25〜2026-07-27（週次10点・各点のサンプル数 n=244〜262件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
