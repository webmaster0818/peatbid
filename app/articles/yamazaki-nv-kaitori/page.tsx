    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt="山崎ノンエイジの買取相場" width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">山崎ノンエイジの買取相場と高く売る完全ガイド</h1>
          ...
          <p>2026年5月現在、山崎ノンエイジ（未開封・箱付き）の買取相場は<strong>約18,000円前後</strong>。希少度は<strong>コモン</strong>クラスに位置し、現行品として安定流通しているが、銘柄によってはプレミア化の兆しあり。市場価値は中位だが、コレクター入門品として安定需要を持つ。</p>
          ...
          <p>2026年5月時点での山崎ノンエイジの買取相場は<strong>15,300円〜18,000円</strong>のレンジで推移しています（未開封・箱付きの場合）。この相場は、以下の市場データの集約から算出しています:</p>
          ...
          <p>山崎ノンエイジの査定額は、ボトルの状態と付属品の有無により大きく変動します。以下のビジュアルガイドで、5段階の主要状態を確認してください:</p>
          ...
          <div className="not-prose">
            ...
            <ul className="list-disc list-inside text-sm space-y-1 text-warm-gray">
              <li><Link href="/articles/yamazaki-nv-takaku-uru/" className="text-amber-dark hover:text-burgundy underline">山崎ノンエイジの高く売るコツ</Link></li>
              <li><Link href="/articles/yamazaki-nv-nisemono-mikata/" className="text-amber-dark hover:text-burgundy underline">山崎ノンエイジの偽物の見分け方</Link></li>
              <li><Link href="/articles/yamazaki-nv-ranking/" className="text-amber-dark hover:text-burgundy underline">山崎ノンエイジの買取業者ランキング</Link></li>
              <li><Link href="/articles/yamazaki-nv-rekishi/" className="text-amber-dark hover:text-burgundy underline">山崎ノンエイジの蒸溜所の歴史</Link></li>
            </ul>
          </div>
