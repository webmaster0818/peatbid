        ...
        <article className="prose">
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="山崎ノンエイジのヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,155.1 145.4,38.9 224.9,38.9 304.3,38.9 383.7,38.9 463.1,38.9 542.6,38.9 622.0,38.9" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-05-25: 10,161円（サンプル n=244件）</title></circle>
              <circle cx="145.4" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-01: 10,175円（サンプル n=250件）</title></circle>
              <circle cx="224.9" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-08: 10,175円（サンプル n=248件）</title></circle>
              <circle cx="304.3" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-15: 10,175円（サンプル n=252件）</title></circle>
              <circle cx="383.7" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 10,175円（サンプル n=248件）</title></circle>
              <circle cx="463.1" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 10,175円（サンプル n=252件）</title></circle>
              <circle cx="542.6" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 10,175円（サンプル n=258件）</title></circle>
              <circle cx="622.0" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 10,175円（サンプル n=258件）</title></circle>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-05-25〜2026-07-13（週次8点・各点のサンプル数 n=244〜258件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
