...
export const metadata: Metadata = {
  title: '竹鶴25年はラベル汚れ・破れでも売れる?【2026年9月最新】状態別の買取査定額',
  description: '竹鶴25年のラベル汚れ・破れ・剥がれ・水濡れ跡がある場合の買取査定額を詳細解説。状態別の価格目安、ラベル保護の保管方法、業者選定まで完全ガイド。',
};
...
export default function Taketsuru25LabelYogorePage() {
  return (
    <>
      <FaqSchema />
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/taketsuru-25.png" alt='竹鶴25年のラベル汚れ・破れがあっても売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">竹鶴25年のラベル汚れ・破れがあっても売れる？</h1>
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-2" className="hover:underline">3. ラベル状態別の査定額目安（竹鶴25年）</a></li>
          ...
          <p>長期保管した竹鶴25年のラベルが汚れた、破れた、水濡れ跡がついた——そんな場合でも、買取は可能です。本記事では、ラベルの状態が査定額にどう影響するか、状態別の価格目安と対処法を完全解説します。</p>
          ...
          <h2 id="section-2">3. ラベル状態別の査定額目安（竹鶴25年）</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴25年の実勢中央値<strong>190,500円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 190,500円（100%）</li><li><strong>軽度の汚れ</strong>: 約171,450円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約152,400円（80%程度）</li><li><strong>破れ・欠け</strong>: 約123,820円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約95,250円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約76,200円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約38,100円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
