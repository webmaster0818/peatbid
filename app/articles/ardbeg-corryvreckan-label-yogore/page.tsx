        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-1" className="hover:underline">2. ラベル状態別の査定額目安（アードベッグ コリーヴレッカン）</a></li>
          ...
          <h2 id="section-1">2. ラベル状態別の査定額目安（アードベッグ コリーヴレッカン）</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>アードベッグ コリーヴレッカンの実勢中央値<strong>8,085円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 8,085円（100%）</li><li><strong>軽度の汚れ</strong>: 約7,280円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約6,470円（80%程度）</li><li><strong>破れ・欠け</strong>: 約5,260円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約4,040円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約3,230円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約1,620円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
