...
export const metadata: Metadata = {
  title: 'イチローズモルト カードシリーズは箱なしでも買取できる?【2026年8月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/ichirosu-card.png" alt='イチローズモルト カードシリーズが箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
