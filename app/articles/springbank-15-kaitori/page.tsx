    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>スプリングバンク15年の市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>35,000円</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=108件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="スプリングバンク15年のヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,80.9 116.5,80.9 167.1,59.9 217.6,38.9 268.2,80.9 318.7,80.9 369.3,59.9 419.8,59.9 470.4,80.9 520.9,80.9 571.5,155.1 622.0,80.9" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="80.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-05-25: 35,000円（サンプル n=90件）</title></circle>
              <circle cx="116.5" cy="80.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-01: 35,000円（サンプル n=94件）</title></circle>
              <circle cx="167.1" cy="59.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-08: 35,099円（サンプル n=92件）</title></circle>
              <circle cx="217.6" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-15: 35,198円（サンプル n=94件）</title></circle>
              <circle cx="268.2" cy="80.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 35,000円（サンプル n=98件）</title></circle>
              <circle cx="318.7" cy="80.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 35,000円（サンプル n=96件）</title></circle>
              <circle cx="369.3" cy="59.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 35,099円（サンプル n=100件）</title></circle>
              <circle cx="419.8" cy="59.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 35,099円（サンプル n=100件）</title></circle>
              <circle cx="470.4" cy="80.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-20: 35,000円（サンプル n=98件）</title></circle>
              <circle cx="520.9" cy="80.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-27: 35,000円（サンプル n=106件）</title></circle>
              <circle cx="571.5" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-03: 34,650円（サンプル n=110件）</title></circle>
              <circle cx="622.0" cy="80.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-10: 35,000円（サンプル n=108件）</title></circle>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-05-25〜2026-08-10（週次12点・各点のサンプル数 n=90〜110件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
