    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>イチローズモルト カードシリーズの基準価格 1,500万円に対し、ラベル状態でこう変動します:<br/>- <strong>新品同様</strong>: 1,500万円（100%）<br/>- <strong>軽度の汚れ</strong>: 1,350万円（90%程度）<br/>- <strong>シミ・水濡れ跡</strong>: 1,200万円（80%程度）<br/>- <strong>破れ・欠け</strong>: 975万円（65%程度）<br/>- <strong>強い退色・大きな損傷</strong>: 750万円（50%程度）</p>` }} />
