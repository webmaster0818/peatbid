...
export const metadata: Metadata = {
  title: '余市ノンエイジは箱なしでも買取できる?【2026年8月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/yoichi-nv.png" alt='余市ノンエイジが箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>余市ノンエイジの場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 市場相場が基準（100%）</li><li><strong>箱あり・冊子なし</strong>: 市場相場の85〜95%程度</li><li><strong>箱なし・冊子あり</strong>: 市場相場の85〜92%程度</li><li><strong>箱なし・ラベル良好</strong>: 市場相場の80〜90%程度</li><li><strong>箱・冊子なし</strong>: 市場相場の75〜85%程度
