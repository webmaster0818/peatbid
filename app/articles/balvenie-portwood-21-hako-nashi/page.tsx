...
export const metadata: Metadata = {
  title: 'バルヴェニー ポートウッド 21年は箱なしでも買取できる?【2026年6月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/balvenie-portwood-21.png" alt='バルヴェニー ポートウッド 21年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>バルヴェニー ポートウッド 21年の場合、実勢中央値<strong>31,425円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 31,425円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約26,710〜29,850円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約26,710〜28,910円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約25,140〜28,280円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約23,570〜26,710円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約7,860円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
