    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt="竹鶴17年の買取相場" width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">竹鶴17年の買取相場と高く売る完全ガイド</h1>
          ...
          <p>2026年5月現在、竹鶴17年（未開封・箱付き）の買取相場は<strong>約150,000円前後</strong>。希少度は<strong>ハイ</strong>クラスに位置し、希少性と国際的評価により、二次流通市場で高値が定着している銘柄帯。コレクター・投資需要が支え、長期保有での価値増大が期待できる。</p>
          ...
          <p>2026年5月時点での竹鶴17年の買取相場は<strong>127,500円〜150,000円</strong>のレンジで推移しています（未開封・箱付きの場合）。この相場は、以下の市場データの集約から算出しています:</p>
          ...
          <p>竹鶴17年の査定額は、ボトルの状態と付属品の有無により大きく変動します。以下のビジュアルガイドで、5段階の主要状態を確認してください:</p>
          ...
          <div className="not-prose">
            ...
            <ul className="list-disc list-inside text-sm space-y-1 text-warm-gray">
              <li><Link href="/articles/taketsuru-17-takaku-uru/" className="text-amber-dark hover:text-burgundy underline">竹鶴17年の高く売るコツ</Link></li>
              <li><Link href="/articles/taketsuru-17-nisemono-mikata/" className="text-amber-dark hover:text-burgundy underline">竹鶴17年の偽物の見分け方</Link></li>
              <li><Link href="/articles/taketsuru-17-ranking/" className="text-amber-dark hover:text-burgundy underline">竹鶴17年の買取業者ランキング</Link></li>
              <li><Link href="/articles/taketsuru-17-rekishi/" className="text-amber-dark hover:text-burgundy underline">竹鶴17年の蒸溜所の歴史</Link></li>
            </ul>
          </div>
