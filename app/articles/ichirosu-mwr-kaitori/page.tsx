...
export const metadata: Metadata = {
  title: 'イチローズモルト MWRの買取相場【2026年6月最新】8,300円・Yahoo中央値ベース完全ガイド',
  description: 'イチローズモルト MWR（Ichiros Malt MWR）の買取相場の最新目安（Yahoo Auctions 過去180日落札中央値ベース）。箱なし・開封済み等の状態別目安、買取業者4社の比較、高く売るコツ、贋作リスクまで網羅。売却検討者必読の決定版ガイド。',
};
