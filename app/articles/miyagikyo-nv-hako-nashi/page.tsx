...
export const metadata: Metadata = {
  title: '宮城峡ノンエイジが箱なしでも買取できる？【2026年完全版】査定額への影響と代替戦略',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt='宮城峡ノンエイジが箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>宮城峡ノンエイジの場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 17,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 14,450円〜16,150円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 14,450円〜15,640円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 13,600円〜15,300円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 12,750円〜14,450円（75〜85%）

つまり、最大で<strong>約25%（4,250円）の差</strong>が生じる可能性があります。</li></ol>` }} />
