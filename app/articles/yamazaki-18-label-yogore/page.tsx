...
export const metadata: Metadata = {
  title: '山崎18年のラベル汚れ・破れがあっても売れる？【2026年完全版】状態別査定額と保護方法',
        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-1" className="hover:underline">2. ラベル状態別の査定額目安（山崎18年）</a></li>
          ...
          <h2 id="section-1">2. ラベル状態別の査定額目安（山崎18年）</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>山崎18年の実勢中央値<strong>93,091円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 93,091円（100%）</li><li><strong>軽度の汚れ</strong>: 約83,780円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約74,470円（80%程度）</li><li><strong>破れ・欠け</strong>: 約60,510円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約46,550円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約37,240円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約18,620円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
