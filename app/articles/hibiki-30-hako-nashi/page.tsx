    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響30年の場合、実勢中央値<strong>539,550円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 539,550円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約458,620〜512,570円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約458,620〜496,390円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約431,640〜485,600円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約404,660〜458,620円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約134,890円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
