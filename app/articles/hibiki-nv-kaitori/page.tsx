...
export const metadata: Metadata = {
  title: '響ジャパニーズハーモニーの買取相場【2026年8月最新】11,110円｜箱なし・開封済みの査定額も',
