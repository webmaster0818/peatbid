    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div className="table-wrapper">
            <table>
              <tbody>
                ...
                <tr><td><strong>市場相場（Yahoo中央値）</strong></td><td><strong>10,723円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>響ジャパニーズハーモニーの市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>10,723円</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=284件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="響ジャパニーズハーモニーのヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,38.9 116.5,72.8 167.1,155.1 217.6,155.0 268.2,155.1 318.7,132.5 369.3,94.0 419.8,94.0 470.4,113.3 520.9,127.1 571.5,94.0 622.0,132.8" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-15: 11,660円（サンプル n=272件）</title></circle>
              <circle cx="116.5" cy="72.8" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 11,322円（サンプル n=268件）</title></circle>
              <circle cx="167.1" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 10,500円（サンプル n=228件）</title></circle>
              <circle cx="217.6" cy="155.0" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 10,501円（サンプル n=228件）</title></circle>
              <circle cx="268.2" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 10,500円（サンプル n=228件）</title></circle>
              <circle cx="318.7" cy="132.5" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-20: 10,726円（サンプル n=276件）</title></circle>
              <circle cx="369.3" cy="94.0" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-27: 11,110円（サンプル n=276件）</title></circle>
              <circle cx="419.8" cy="94.0" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-03: 11,110円（サンプル n=284件）</title></circle>
              <circle cx="470.4" cy="113.3" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-10: 10,917円（サンプル n=268件）</title></circle>
              <circle cx="520.9" cy="127.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-17: 10,779円（サンプル n=268件）</title></circle>
              <circle cx="571.5" cy="94.0" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-24: 11,110円（サンプル n=280件）</title></circle>
              <circle cx="622.0" cy="132.8" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-31: 10,723円（サンプル n=284件）</title></circle>
              <text x="618.0" y="122.8" fontSize="11" fontWeight="bold" fill="#8A5A18" textAnchor="end">10,723円</text>
              <text x="66.0" y="198" fontSize="10" fill="#807565" textAnchor="middle">6/15</text>
              <text x="318.7" y="198" fontSize="10" fill="#807565" textAnchor="middle">7/20</text>
              <text x="622.0" y="198" fontSize="10" fill="#807565" textAnchor="middle">8/31</text>
            </svg>
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-06-15〜2026-08-31（週次12点・各点のサンプル数 n=228〜284件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
          ...
          <div className="table-wrapper">
            <table>
              ...
              <tbody>
                <tr><td>未開封・完璧</td><td>箱・冊子・カートン揃い</td><td>市場相場の95〜100%程度</td><td><strong>約10,190〜10,720円</strong></td></tr>
                <tr><td>未開封・箱なし</td><td>ラベル良好</td><td>市場相場の80〜90%程度</td><td><strong>約8,580〜9,650円</strong></td></tr>
                <tr><td>未開封・冊子なし</td><td>外箱あり</td><td>市場相場の85〜95%程度</td><td><strong>約9,110〜10,190円</strong></td></tr>
                <tr><td>未開封・ラベル軽度汚れ</td><td>付属あり</td><td>市場相場の75〜88%程度</td><td><strong>約8,040〜9,440円</strong></td></tr>
                <tr><td>未開封・ラベル損傷</td><td>付属あり</td><td>市場相場の60〜75%程度</td><td><strong>約6,430〜8,040円</strong></td></tr>
                <tr><td>未開封・液面減少</td><td>やや進行</td><td>市場相場の55〜70%程度</td><td><strong>約5,900〜7,510円</strong></td></tr>
                <tr><td>開封済み・9割以上残</td><td>付属あり</td><td>市場相場の30〜40%程度</td><td><strong>約3,220〜4,290円</strong></td></tr>
                <tr><td>開封済み・半分以下残</td><td>付属あり</td><td>市場相場の15〜25%程度</td><td><strong>約1,610〜2,680円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>「響ジャパニーズハーモニー 買取 箱無し」とお調べの方向けの目安です。未開封・箱なし（ラベル良好）の場合、業界一般の目安は<strong>市場相場の80〜90%程度（約8,580〜9,650円）</strong>。外箱・冊子の揃った完品と比べて1〜2割の減額にとどまるため、<strong>箱がなくても売却を諦める必要はありません</strong>。</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 not-prose">
            ...
            <Link href="/articles/taketsuru-25-kaitori/" className="block bg-white border border-warm-border rounded-xl p-4 hover:shadow-md transition-shadow"><span className="text-xs text-amber-dark font-bold">関連銘柄</span><p className="text-sm font-bold mt-1">竹鶴25年 の買取相場</p><p className="text-xs text-warm-gray mt-1">市場相場 189,000円</p></Link>
            <Link href="/articles/chichibu-the-first-kaitori/" className="block bg-white border border-warm-border rounded-xl p-4 hover:shadow-md transition-shadow"><span className="text-xs text-amber-dark font-bold">関連銘柄</span><p className="text-sm font-bold mt-1">秩父ザファースト の買取相場</p><p className="text-xs text-warm-gray mt-1">市場相場 95,100円</p></Link>
          ...
          <p className="text-xs text-warm-gray mt-8">※本記事の市場相場は Yahoo Auctions 過去180日落札データの中央値（取得日 2026-08-31）です。業者の買取査定額は各社の在庫状況・キャンペーンにより変動するため、最新の査定額は各業者ページで直接ご確認ください。当サイトはアフィリエイト広告（PR）を含みます。</p>
        </article>
      </div>
    </>
  );
