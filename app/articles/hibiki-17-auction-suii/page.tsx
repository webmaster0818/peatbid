...
export const metadata: Metadata = {
  title: "響17年のオークション相場推移【2026年完全版】Sotheby's/Bonhams/海外データ完全分析",
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-hibiki.png" alt='響17年のオークション相場推移' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
