    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div className="table-wrapper">
            <table>
              <tbody>
                ...
                <tr><td><strong>市場相場（Yahoo中央値）</strong></td><td><strong>10,000円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>白州ノンエイジの市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>10,000円</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=218件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="白州ノンエイジのヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,38.9 116.5,38.9 167.1,155.1 217.6,155.1 268.2,155.1 318.7,155.1 369.3,155.1 419.8,155.1 470.4,155.1 520.9,155.1 571.5,100.9 622.0,84.7" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-01: 10,065円（サンプル n=268件）</title></circle>
              <circle cx="116.5" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-08: 10,065円（サンプル n=274件）</title></circle>
              <circle cx="167.1" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-15: 9,900円（サンプル n=210件）</title></circle>
              <circle cx="217.6" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 9,900円（サンプル n=198件）</title></circle>
              <circle cx="268.2" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 9,900円（サンプル n=196件）</title></circle>
              <circle cx="318.7" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 9,900円（サンプル n=210件）</title></circle>
              <circle cx="369.3" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 9,900円（サンプル n=200件）</title></circle>
              <circle cx="419.8" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-20: 9,900円（サンプル n=190件）</title></circle>
              <circle cx="470.4" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-27: 9,900円（サンプル n=198件）</title></circle>
              <circle cx="520.9" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-03: 9,900円（サンプル n=204件）</title></circle>
              <circle cx="571.5" cy="100.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-10: 9,977円（サンプル n=212件）</title></circle>
              <circle cx="622.0" cy="84.7" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-17: 10,000円（サンプル n=218件）</title></circle>
              <text x="618.0" y="74.7" fontSize="11" fontWeight="bold" fill="#8A5A18" textAnchor="end">10,000円</text>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-06-01〜2026-08-17（週次12点・各点のサンプル数 n=190〜274件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
          ...
          <div className="table-wrapper">
            <table>
              ...
              <tbody>
                <tr><td>未開封・完璧</td><td>箱・冊子・カートン揃い</td><td>市場相場の95〜100%程度</td><td><strong>約9,500〜10,000円</strong></td></tr>
                <tr><td>未開封・箱なし</td><td>ラベル良好</td><td>市場相場の80〜90%程度</td><td><strong>約8,000〜9,000円</strong></td></tr>
                <tr><td>未開封・冊子なし</td><td>外箱あり</td><td>市場相場の85〜95%程度</td><td><strong>約8,500〜9,500円</strong></td></tr>
                <tr><td>未開封・ラベル軽度汚れ</td><td>付属あり</td><td>市場相場の75〜88%程度</td><td><strong>約7,500〜8,800円</strong></td></tr>
                <tr><td>未開封・ラベル損傷</td><td>付属あり</td><td>市場相場の60〜75%程度</td><td><strong>約6,000〜7,500円</strong></td></tr>
                <tr><td>未開封・液面減少</td><td>やや進行</td><td>市場相場の55〜70%程度</td><td><strong>約5,500〜7,000円</strong></td></tr>
          ...
          <p>「白州ノンエイジ 買取 箱無し」とお調べの方向けの目安です。未開封・箱なし（ラベル良好）の場合、業界一般の目安は<strong>市場相場の80〜90%程度（約8,000〜9,000円）</strong>。外箱・冊子の揃った完品と比べて1〜2割の減額にとどまるため、<strong>箱がなくても売却を諦める必要はありません</strong>。</p>
