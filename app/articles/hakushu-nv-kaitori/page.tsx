...
export default function HakushuNvKaitoriPage() {
  return (
    <>
      <FaqSchema />
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        <nav aria-label="パンくずリスト" className="text-xs text-warm-gray mb-6">
          <ol className="flex items-center gap-1">
            ...
            <li className="breadcrumb-sep" />
            <li><span className="text-foreground">白州ノンエイジ</span></li>
          </ol>
        </nav>

        <div className="article-hero mb-8">
          <Image src="/images/heroes/hakushu-nv.png" alt="白州ノンエイジの買取相場" width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">白州ノンエイジの買取相場と業者比較ガイド【2026年8月】</h1>
          ...
          <h2 id="summary">1. 白州ノンエイジの概要</h2>

          <p>白州ノンエイジはジャパニーズウイスキーを代表する銘柄の1つで、白州蒸溜所が手がけるノンエイジ（NV）のボトルです。白州ノンエイジ。森のウイスキー。</p>

          <p>なお、白州ノンエイジはラベルに熟成年数の表記がないボトルで、オークションや買取店では「<strong>白州 年代指定なし</strong>」「<strong>白州 NV（ノンヴィンテージ）</strong>」とも表記されます。いずれも本ページの相場が目安になります。</p>

          <div className="bg-cream/40 border border-amber/40 rounded-xl p-4 my-5 not-prose">
            <p className="text-sm text-ink">🔀 「12年」など熟成年数の表記がある白州をお探しの方はこちら → <Link href="/articles/hakushu-12-kaitori/" className="text-amber-dark underline font-bold">白州12年の買取相場ガイド</Link></p>
          </div>


          <p>本記事の市場相場は <strong>Yahoo Auctions 過去180日の落札データを集計した中央値</strong>（IQR外れ値除去後）に基づきます。白州ノンエイジは希少度<strong>コモン</strong>クラスに位置し、現行品として安定流通しているが、銘柄によってはプレミア化の兆しあり。市場価値は中位だが、コレクター入門品として安定需要を持つ。</p>
          ...
          <div className="table-wrapper">
            <table>
              <tbody>
                ...
                <tr><td><strong>市場相場（Yahoo中央値）</strong></td><td><strong>9,977円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="relative w-full h-[200px] md:h-[260px] rounded-xl overflow-hidden mb-5 not-prose">
            <Image src="/images/distillery-japanese.png" alt="白州蒸溜所の蒸溜所イメージ" fill sizes="(max-width: 768px) 100vw, 800px" className="object-cover" />
          </div>

          <p>1973年（昭和48年）創業、サントリーが山梨県北杜市・南アルプス山系の麓に開設した蒸溜所。標高約700メートルの森林に囲まれた立地と、ミネラル分の少ない軟水を使用。「森のウイスキー」と称される爽やかで軽快な味わいが特徴。</p>

          <p>白州蒸溜所が生み出すジャパニーズウイスキーは、世界の主要品評会で度々受賞しており、二次流通市場でも継続的に高値で取引されています。蒸溜所の歴史と職人技術が、白州ノンエイジのような銘柄の市場価値を支えています。</p>

          <p>同じ蒸溜所の他の銘柄や、同年代の他銘柄との関連性を知ることで、白州ノンエイジの市場における立ち位置がより明確になります。下の関連銘柄リンクから他のグレード・他蒸溜所の銘柄も合わせてチェックすることをおすすめします。</p>

          <h2 id="tasting">3. テイスティングノート</h2>

          <p>白州ノンエイジの味わいは、ノンエイジ（NV）の熟成期間中に樽から溶け出した成分と、白州蒸溜所独自の蒸溜技術が複雑に交差したものです。</p>
          ...
          <p>白州ノンエイジの市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>9,977円</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=212件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>

          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            <p className="text-sm font-bold text-ink mb-3">白州ノンエイジの買取相場 直近12週の推移（ヤフオク落札中央値・毎週更新）</p>
            <svg viewBox="0 0 640 210" role="img" aria-label="白州ノンエイジのヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              <line x1="66" y1="38.9" x2="622" y2="38.9" stroke="#E5DCC4" strokeDasharray="3 3" strokeWidth="1" /><text x="60" y="42.4" fontSize="10" fill="#807565" textAnchor="end">10,065</text>
              <line x1="66" y1="97.0" x2="622" y2="97.0" stroke="#E5DCC4" strokeDasharray="3 3" strokeWidth="1" /><text x="60" y="100.5" fontSize="10" fill="#807565" textAnchor="end">9,982</text>
              ...
              <polyline points="66.0,84.0 116.5,38.9 167.1,38.9 217.6,155.1 268.2,155.1 318.7,155.1 369.3,155.1 419.8,155.1 470.4,155.1 520.9,155.1 571.5,155.1 622.0,100.9" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="84.0" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-05-25: 10,001円（サンプル n=290件）</title></circle>
              <circle cx="116.5" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-01: 10,065円（サンプル n=268件）</title></circle>
              <circle cx="167.1" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-08: 10,065円（サンプル n=274件）</title></circle>
              <circle cx="217.6" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-15: 9,900円（サンプル n=210件）</title></circle>
              <circle cx="268.2" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 9,900円（サンプル n=198件）</title></circle>
              <circle cx="318.7" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 9,900円（サンプル n=196件）</title></circle>
              <circle cx="369.3" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 9,900円（サンプル n=210件）</title></circle>
              <circle cx="419.8" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 9,900円（サンプル n=200件）</title></circle>
              <circle cx="470.4" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-20: 9,900円（サンプル n=190件）</title></circle>
              <circle cx="520.9" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-27: 9,900円（サンプル n=198件）</title></circle>
              <circle cx="571.5" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-03: 9,900円（サンプル n=204件）</title></circle>
              <circle cx="622.0" cy="100.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-10: 9,977円（サンプル n=212件）</title></circle>
              <text x="618.0" y="90.9" fontSize="11" fontWeight="bold" fill="#8A5A18" textAnchor="end">9,977円</text>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-05-25〜2026-08-10（週次12点・各点のサンプル数 n=190〜290件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
          ...
          <p>白州ノンエイジの査定額は、ボトルの状態と付属品の有無により大きく変動します。以下は <strong>業界一般の目安（％）</strong> で、市場相場（Yahoo中央値）を基準とした概算レンジです。**実際の査定額は業者により異なります**ので、最終的な金額は各業者のページからご確認ください。</p>
          ...
          <div className="table-wrapper">
            <table>
              ...
              <tbody>
                <tr><td>未開封・完璧</td><td>箱・冊子・カートン揃い</td><td>市場相場の95〜100%程度</td><td><strong>約9,480〜9,980円</strong></td></tr>
                <tr><td>未開封・箱なし</td><td>ラベル良好</td><td>市場相場の80〜90%程度</td><td><strong>約7,980〜8,980円</strong></td></tr>
                <tr><td>未開封・冊子なし</td><td>外箱あり</td><td>市場相場の85〜95%程度</td><td><strong>約8,480〜9,480円</strong></td></tr>
                <tr><td>未開封・ラベル軽度汚れ</td><td>付属あり</td><td>市場相場の75〜88%程度</td><td><strong>約7,480〜8,780円</strong></td></tr>
                <tr><td>未開封・ラベル損傷</td><td>付属あり</td><td>市場相場の60〜75%程度</td><td><strong>約5,990〜7,480円</strong></td></tr>
                <tr><td>未開封・液面減少</td><td>やや進行</td><td>市場相場の55〜70%程度</td><td><strong>約5,490〜6,980円</strong></td></tr>
                <tr><td>開封済み・9割以上残</td><td>付属あり</td><td>市場相場の30〜40%程度</td><td><strong>約2,990〜3,990円</strong></td></tr>
                <tr><td>開封済み・半分以下残</td><td>付属あり</td><td>市場相場の15〜25%程度</td><td><strong>約1,500〜2,490円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <h3 id="hako-nashi-souba">白州ノンエイジを箱なし・付属品なしで売る場合の買取相場</h3>

          <p>「白州ノンエイジ 買取 箱無し」とお調べの方向けの目安です。未開封・箱なし（ラベル良好）の場合、業界一般の目安は<strong>市場相場の80〜90%程度（約7,980〜8,980円）</strong>。外箱・冊子の揃った完品と比べて1〜2割の減額にとどまるため、<strong>箱がなくても売却を諦める必要はありません</strong>。</p>
          ...
          <ul>
            ...
            <li>詳しくは<Link href="/articles/hakushu-nv-hako-nashi/" className="text-amber-dark hover:underline">白州ノンエイジは箱なしでも買取してもらえるかの徹底ガイド</Link>をご覧ください</li>
          </ul>

          <h2 id="price-reasons">6. なぜ白州ノンエイジはこの価格になるのか</h2>

          <p>白州ノンエイジの二次流通価格を決定づける主要な要因は5つあります:</p>
          ...
          <p>これらの要因を総合的に踏まえると、白州ノンエイジはコモンクラスの希少度を持つため、<strong>中長期で見れば価格安定〜上昇基調</strong>が予想されます。短期的な売り急ぎは避け、市場動向を見ながら最適なタイミングで売却するのが合理的です。</p>
          ...
          <p>海外の主要オークションでは、白州ノンエイジクラスの銘柄が継続的に取引されています。主要オークションプラットフォームと、それぞれの特徴は以下の通りです:</p>
          ...
          <p>過去5年（2021〜2026年）の白州ノンエイジの二次流通価格は、ジャパニーズウイスキーブーム・コレクター需要拡大により<strong>累積30〜80%の上昇</strong>を示しており、長期保有における資産価値も注目されています。</p>

          <h2 id="takaku-uru">8. 白州ノンエイジを高く売る7つの実践テクニック</h2>
          ...
          <h2 id="fake">9. 白州ノンエイジの偽物・贋作の見分け方</h2>

          <p>白州ノンエイジのような流通価値のある銘柄では、贋作・偽造ボトルのリスクが存在します。本物を見抜くには以下の5つのチェックが有効です:</p>
          ...
          <p>PeatBid編集部が白州ノンエイジクラスの銘柄に強い買取業者を厳選しました。それぞれ得意領域が異なるため、目的別に使い分けるのがコツです。</p>
          ...
          <p>白州ノンエイジを売却する際の標準的なプロセスを5ステップでまとめました:</p>
          ...
          <ul>
              ...
              <li><Link href="/articles/hakushu-nv-nisemono-mikata/" className="text-amber-dark hover:underline">白州ノンエイジの売る前チェック（真贋と相場）</Link></li>
              <li><Link href="/articles/hakushu-nv-ranking/" className="text-amber-dark hover:underline">白州ノンエイジの買取業者ランキング</Link></li>
              <li><Link href="/articles/hakushu-nv-rekishi/" className="text-amber-dark hover:underline">白州ノンエイジの歴史と特徴</Link></li>
              <li><Link href="/articles/hakushu-nv-kihaku/" className="text-amber-dark hover:underline">白州ノンエイジの希少性・投資価値</Link></li>
              <li><Link href="/articles/hakushu-nv-auction-suii/" className="text-amber-dark hover:underline">白州ノンエイジのオークション推移</Link></li>
              <li><Link href="/articles/hakushu-nv-kaifu-zumi/" className="text-amber-dark hover:underline">白州ノンエイジの開封済みでも売れる</Link></li>
              <li><Link href="/articles/hakushu-nv-hako-nashi/" className="text-amber-dark hover:underline">白州ノンエイジの箱なしでも買取</Link></li>
              <li><Link href="/articles/hakushu-nv-label-yogore/" className="text-amber-dark hover:underline">白州ノンエイジのラベル汚れでも査定</Link></li>
          </ul>
