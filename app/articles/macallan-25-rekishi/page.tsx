...
export const metadata: Metadata = {
  title: 'マッカラン25年の歴史と特徴【2026年完全版】蒸溜所・受賞歴・市場評価の根拠',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-hibiki.png" alt='マッカラン25年の歴史と特徴' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-1" className="hover:underline">2. マッカラン25年の誕生背景</a></li>
              <li><a href="#section-2" className="hover:underline">3. マッカラン25年の味わいプロファイル</a></li>
          ...
          <h2 id="section-1">2. マッカラン25年の誕生背景</h2>
          ...
          <h2 id="section-2">3. マッカラン25年の味わいプロファイル</h2>
