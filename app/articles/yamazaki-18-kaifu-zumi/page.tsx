...
export const metadata: Metadata = {
  title: '山崎18年が開封済みでも売れる？【2026年完全版】残量別査定額と賢い売却法',
        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              <li><a href="#section-0" className="hover:underline">1. 開封済み山崎18年の査定額の目安</a></li>
          ...
          <h2 id="section-0">1. 開封済み山崎18年の査定額の目安</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きの実勢中央値<strong>93,091円</strong>を基準として、開封済みは残量・状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 約27,930〜37,240円（30〜40%）</li><li><strong>7割以上残</strong>: 約23,270〜32,580円（25〜35%）</li><li><strong>5割以上残</strong>: 約18,620〜27,930円（20〜30%）</li><li><strong>3割以上残</strong>: 約9,310〜18,620円（10〜20%）</li><li><strong>1割以下残</strong>: 買取不可の場合あり、もしくは空ボトルとして数千円
