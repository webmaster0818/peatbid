...
export const metadata: Metadata = {
  title: 'バルヴェニー ポートウッド 21年のオークション相場推移と買取価格【2026年6月最新】国内外データ分析',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/balvenie-portwood-21.png" alt='バルヴェニー ポートウッド 21年のオークション相場推移' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
