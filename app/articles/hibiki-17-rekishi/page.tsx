...
export const metadata: Metadata = {
  title: '響17年の歴史と特徴【2026年完全版】蒸溜所・受賞歴・市場評価の根拠',
        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-1" className="hover:underline">2. 響17年の誕生背景</a></li>
              <li><a href="#section-2" className="hover:underline">3. 響17年の味わいプロファイル</a></li>
          ...
          <h2 id="section-1">2. 響17年の誕生背景</h2>
          ...
          <h2 id="section-2">3. 響17年の味わいプロファイル</h2>
