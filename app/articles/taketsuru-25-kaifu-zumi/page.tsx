...
export const metadata: Metadata = {
  title: '竹鶴25年が開封済みでも売れる？【2026年最新】残量別の査定額と売却ガイド',
  description: '竹鶴25年を開封済みで売る場合の査定額と注意点。残量別の価格目安、状態保持のコツ、開封済み歓迎の買取業者を解説。',
};
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        <nav aria-label="パンくずリスト" className="text-xs text-warm-gray mb-6">
          <ol className="flex items-center gap-1">
            ...
            <li className="breadcrumb-sep" />
            <li><span className="text-foreground">開封済み竹鶴25年の査定額の目安</span></li>
          </ol>
        </nav>
        ...
        <article className="prose">
          ...
          <p>「竹鶴25年を開けてしまった……もう売れない？」と諦めている方、ご安心ください。開封済みでも、状態と残量次第で買取は可能です。本記事では、開封済みの竹鶴25年を最大限の価格で売る方法を解説します。</p>

          <h2>開封済み竹鶴25年の査定額の目安</h2>

          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きが基準価格約800,000円に対し、開封済みは状態により以下のレンジで査定されます:<br/>- <strong>9割以上残</strong>: 基準の30〜40%（240,000円〜320,000円）<br/>- <strong>半分以上残</strong>: 基準の20〜30%（160,000円〜240,000円）<br/>- <strong>半分未満</strong>: 査定額が大きく下がる、買取不可の場合あり</p>` }} />
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>以下のような竹鶴25年は、開封済みでも高めの査定が期待できます:<br/>- 終売・希少銘柄（流通量が極小）<br/>- 古いボトリング（ヴィンテージ価値）<br/>- 外箱・冊子が完全保存<br/>- 残量が9割以上で蓋がしっかり閉まっている</p>` }} />

          <h2>売却までの保管のコツ</h2>

          <div dangerouslySetInnerHTML={{ __html: `<p>開封後の竹鶴25年は、なるべく早く売却するか、適切に保管しましょう:<br/>- 立てて保管（横置きはコルク劣化）<br/>- 直射日光なし、室温20℃以下<br/>- できれば未開封同等の場所で<br/>- 売却まで開けない、注ぎ足しはしない</p>` }} />
