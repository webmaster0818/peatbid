    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>未開封・箱付きが基準価格約800,000円に対し、開封済みは状態により以下のレンジで査定されます:
- **9割以上残**: 基準の30〜40%（240,000円〜320,000円）
- **半分以上残**: 基準の20〜30%（160,000円〜240,000円）
...
5. **キャップ・栓の状態**: しっかり閉まっているか</p>
          ...
          <p>以下のような竹鶴25年は、開封済みでも高めの査定が期待できます:
- 終売・希少銘柄（流通量が極小）
- 古いボトリング（ヴィンテージ価値）
- 外箱・冊子が完全保存
- 残量が9割以上で蓋がしっかり閉まっている</p>
          ...
          <p>開封後の竹鶴25年は、なるべく早く売却するか、適切に保管しましょう:
- 立てて保管（横置きはコルク劣化）
- 直射日光なし、室温20℃以下
- できれば未開封同等の場所で
- 売却まで開けない、注ぎ足しはしない</p>
