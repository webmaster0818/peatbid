...
function Schema() {
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "Article", "headline": 'スプリングバンクの偽物・贋作の見分け方', "datePublished": "2026-06-28", "dateModified": "2026-07-06", "author": {"@type": "Organization", "name": "PeatBid編集部"}, "publisher": {"@type": "Organization", "name": "PeatBid"}}) }} />
    </>
  );
}
