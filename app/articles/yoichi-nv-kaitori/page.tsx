...
export const metadata: Metadata = {
  title: '余市ノンエイジの買取相場ガイド【2026年9月最新】状態別の目安',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">余市ノンエイジの買取相場と業者比較ガイド【2026年9月】</h1>
