    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴21年の実勢中央値<strong>63,030円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 63,030円（100%）</li><li><strong>軽度の汚れ</strong>: 約56,730円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約50,420円（80%程度）</li><li><strong>破れ・欠け</strong>: 約40,970円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約31,520円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約25,210円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約12,610円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
