...
export const metadata: Metadata = {
  title: '竹鶴21年のラベル汚れ・破れがあっても売れる？【2026年完全版】状態別査定額と保護方法',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴21年の実勢中央値<strong>62,549円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 62,549円（100%）</li><li><strong>軽度の汚れ</strong>: 約56,290円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約50,040円（80%程度）</li><li><strong>破れ・欠け</strong>: 約40,660円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約31,270円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約25,020円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約12,510円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
