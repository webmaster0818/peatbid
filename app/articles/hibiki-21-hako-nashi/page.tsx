    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-hibiki.png" alt='響21年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響21年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 420,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 357,000円〜399,000円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 357,000円〜386,400円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 336,000円〜378,000円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 315,000円〜357,000円（75〜85%）

つまり、最大で<strong>約25%（105,000円）の差</strong>が生じる可能性があります。</li></ol>` }} />
...
空き箱の価格は数千円〜数万円程度。査定額アップ幅と比較して、投資価値があるか判断してください。</li></ol>` }} />
          ...
          <div className="not-prose mt-5">
            ...
            <ul className="list-disc list-inside text-sm space-y-1 text-warm-gray">
              ...
              <li><Link href="/articles/hakushu-18-hako-nashi/" className="text-amber-dark hover:text-burgundy underline">白州18年の箱なしの買取</Link></li>
            </ul>
          </div>
