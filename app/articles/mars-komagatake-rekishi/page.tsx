...
export const metadata: Metadata = {
  title: 'マルス駒ヶ岳の歴史・特徴と買取価値【2026年8月最新】なぜ高い?市場評価の根拠',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/mars-komagatake.png" alt='マルス駒ヶ岳の歴史と特徴' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div className="bg-cream/30 border border-warm-border rounded-xl p-4 mb-6 not-prose">
            ...
            <p className="text-xs text-warm-gray mt-1">ジャパニーズウイスキー / 信州マルス蒸溜所 / ノンエイジ / 希少度 コモン / 市場相場 8,248円</p>
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-1" className="hover:underline">2. 信州マルス蒸溜所の創業と歴史</a></li>
              <li><a href="#section-2" className="hover:underline">3. マルス駒ヶ岳の誕生背景</a></li>
              <li><a href="#section-3" className="hover:underline">4. マルス駒ヶ岳の味わいプロファイル</a></li>
          ...
          <div className="bg-cream/40 border-l-4 border-amber rounded-r-xl p-4 my-6 not-prose">
            ...
            <p className="text-sm text-ink leading-relaxed">直近180日のYahoo!オークションではマルス駒ヶ岳の落札が約286件確認でき、落札額の中央値は8,248円でした。取引が活発で換金しやすい銘柄で、本記事の査定目安はこの実勢中央値を基準に算出しています。</p>
          </div>
          ...
          <h2 id="section-2">3. マルス駒ヶ岳の誕生背景</h2>
          ...
          <h2 id="section-3">4. マルス駒ヶ岳の味わいプロファイル</h2>
