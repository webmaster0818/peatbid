...
export const metadata: Metadata = {
  title: 'マッカラン30年のラベル汚れ・破れがあっても売れる？【2026年最新】状態別の査定額目安',
  description: 'マッカラン30年のラベル汚れ・破れ・剥がれ・水濡れ跡がある場合の買取査定額を解説。状態別の価格目安と、ラベルを保護する保管方法。',
};
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-hibiki.png" alt='マッカラン30年のラベル汚れ・破れがあっても売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <p>長期保管したマッカラン30年のラベルが汚れた、破れた、水濡れ跡がついた——そんな場合でも、買取は可能です。本記事では、ラベルの状態が査定額にどう影響するか、状態別の価格目安を解説します。</p>
...
- **強い退色**: 直射日光や蛍光灯による色あせ</p>
          ...
          <p>マッカラン30年の基準価格 150万円に対し、ラベル状態でこう変動します:
- **新品同様**: 150万円（100%）
- **軽度の汚れ**: 135万円（90%程度）
- **シミ・水濡れ跡**: 120万円（80%程度）
