    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div className="table-wrapper">
            <table>
              <tbody>
                ...
                <tr><td><strong>市場相場（Yahoo中央値）</strong></td><td><strong>20,905円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>山崎12年の市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>20,905円</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=248件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="山崎12年のヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,38.9 116.5,57.1 167.1,55.9 217.6,155.1 268.2,155.1 318.7,96.1 369.3,57.1 419.8,57.1 470.4,65.7 520.9,90.9 571.5,75.6 622.0,55.9" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 21,000円（サンプル n=226件）</title></circle>
              <circle cx="116.5" cy="57.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 20,898円（サンプル n=230件）</title></circle>
              <circle cx="167.1" cy="55.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 20,905円（サンプル n=246件）</title></circle>
              <circle cx="217.6" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-20: 20,350円（サンプル n=234件）</title></circle>
              <circle cx="268.2" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-27: 20,350円（サンプル n=248件）</title></circle>
              <circle cx="318.7" cy="96.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-03: 20,680円（サンプル n=244件）</title></circle>
              <circle cx="369.3" cy="57.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-10: 20,898円（サンプル n=238件）</title></circle>
              <circle cx="419.8" cy="57.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-17: 20,898円（サンプル n=240件）</title></circle>
              <circle cx="470.4" cy="65.7" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-24: 20,850円（サンプル n=256件）</title></circle>
              <circle cx="520.9" cy="90.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-31: 20,709円（サンプル n=232件）</title></circle>
              <circle cx="571.5" cy="75.6" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-09-07: 20,795円（サンプル n=250件）</title></circle>
              <circle cx="622.0" cy="55.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-09-14: 20,905円（サンプル n=248件）</title></circle>
              <text x="618.0" y="45.9" fontSize="11" fontWeight="bold" fill="#8A5A18" textAnchor="end">20,905円</text>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-06-29〜2026-09-14（週次12点・各点のサンプル数 n=226〜256件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
          ...
          <div className="table-wrapper">
            <table>
              ...
              <tbody>
                <tr><td>未開封・完璧</td><td>箱・冊子・カートン揃い</td><td>市場相場の95〜100%程度</td><td><strong>約19,860〜20,900円</strong></td></tr>
                <tr><td>未開封・箱なし</td><td>ラベル良好</td><td>市場相場の80〜90%程度</td><td><strong>約16,720〜18,810円</strong></td></tr>
                <tr><td>未開封・冊子なし</td><td>外箱あり</td><td>市場相場の85〜95%程度</td><td><strong>約17,770〜19,860円</strong></td></tr>
                <tr><td>未開封・ラベル軽度汚れ</td><td>付属あり</td><td>市場相場の75〜88%程度</td><td><strong>約15,680〜18,400円</strong></td></tr>
                <tr><td>未開封・ラベル損傷</td><td>付属あり</td><td>市場相場の60〜75%程度</td><td><strong>約12,540〜15,680円</strong></td></tr>
                <tr><td>未開封・液面減少</td><td>やや進行</td><td>市場相場の55〜70%程度</td><td><strong>約11,500〜14,630円</strong></td></tr>
                <tr><td>開封済み・9割以上残</td><td>付属あり</td><td>市場相場の30〜40%程度</td><td><strong>約6,270〜8,360円</strong></td></tr>
                <tr><td>開封済み・半分以下残</td><td>付属あり</td><td>市場相場の15〜25%程度</td><td><strong>約3,140〜5,230円</strong></td></tr>
              </tbody>
            </table>
          </div>
