...
export const metadata: Metadata = {
  title: 'グレンファークラス105（年代指定なし）の買取相場【2026年9月最新】8,225円｜箱なし・開封済みの査定額も',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">グレンファークラス105の買取相場と業者比較ガイド【2026年9月】</h1>
          ...
          <div className="bg-cream/40 border border-amber/40 rounded-xl p-4 my-5 not-prose">
            <p className="text-sm text-ink">🔀 「25年」など熟成年数の表記があるグレンファークラスをお探しの方はこちら → <Link href="/articles/glenfarclas-25-kaitori/" className="text-amber-dark underline font-bold">グレンファークラス25年の買取相場ガイド</Link></p>
          </div>
