      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div className="bg-cream/30 border border-warm-border rounded-xl p-4 mb-6 not-prose">
            ...
            <p className="text-xs text-warm-gray mt-1">ジャパニーズウイスキー / サントリー / 17年熟成 / 希少度 ハイ / 市場相場 47,925円</p>
          ...
          <div className="bg-cream/40 border-l-4 border-amber rounded-r-xl p-4 my-6 not-prose">
            ...
            <p className="text-sm text-ink leading-relaxed">直近180日のYahoo!オークションでは響17年の落札が約276件確認でき、落札額の中央値は47,925円でした。取引が活発で換金しやすい銘柄で、本記事の査定目安はこの実勢中央値を基準に算出しています。</p>
          </div>
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p><strong>響17年</strong>はジャパニーズウイスキー（サントリー）の17年熟成、度数43%、希少度は希少に分類される銘柄です。</p><p>直近180日の実勢中央値は<strong>47,925円</strong>（流通サンプル276件、当サイト独自集計）。価格帯としては<strong>中位帯</strong>にあたり、付属品の有無や保管状態で査定が上下しやすく、コンディション管理が効きます。</p><p>流通量は<strong>潤沢</strong>の水準です。流通量が多く相場が安定しているぶん、付属品・状態の差が査定額に直結します。</p><p>ジャパニーズウイスキーは世界的評価の高まりで需要が強く、特に終売・長期熟成銘柄は中長期で価格が伸びやすい傾向です。一方で短期は為替やオークション結果で振れるため、売り時の見極めが重要になります。</p><p>※ 数値は当サイトがYahoo!オークションの過去180日落札データ（IQRで外れ値除去）から集計した参考値で、買取額を保証するものではありません。</p>` }} />

          <h2 id="section-1">2. 開封済み響17年の査定額の目安</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きの実勢中央値<strong>47,925円</strong>を基準として、開封済みは残量・状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 約14,380〜19,170円（30〜40%）</li><li><strong>7割以上残</strong>: 約11,980〜16,770円（25〜35%）</li><li><strong>5割以上残</strong>: 約9,580〜14,380円（20〜30%）</li><li><strong>3割以上残</strong>: 約4,790〜9,580円（10〜20%）</li><li><strong>1割以下残</strong>: 買取不可の場合あり、もしくは空ボトルとして数千円
