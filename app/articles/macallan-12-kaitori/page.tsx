...
export const metadata: Metadata = {
  title: 'マッカラン12年の買取相場【2026年6月最新】9,113円｜箱なし・開封済みの査定額も',
  description: 'マッカラン12年の買取相場は9,113円が目安（Yahoo Auctions 過去180日落札中央値ベース）。箱なし・開封済み等の状態別の買取価格目安、買取業者4社の比較、高く売るコツ、贋作リスクまで網羅。マッカラン12年を売る前に読む決定版ガイド。',
};
