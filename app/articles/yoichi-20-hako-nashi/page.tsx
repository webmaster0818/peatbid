    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>余市20年の場合、実勢中央値<strong>214,071円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 214,071円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約181,960〜203,370円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約181,960〜196,950円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約171,260〜192,660円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約160,550〜181,960円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約53,520円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
