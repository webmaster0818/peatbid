...
export const metadata: Metadata = {
  title: 'マッカラン ファイン&レアの買取相場【2026年8月最新】8,480円｜箱なし・開封済みの査定額も',
