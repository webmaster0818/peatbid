...
export const metadata: Metadata = {
  title: '響21年の買取相場【2026年6月最新】72,055円｜箱なし・開封済みの査定額も',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">響21年の買取相場と業者比較ガイド【2026年6月】</h1>
