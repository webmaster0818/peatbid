    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>イチローズモルト MWRの場合、実勢中央値<strong>8,291円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 8,291円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約7,050〜7,880円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約7,050〜7,630円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約6,630〜7,460円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約6,220〜7,050円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約2,070円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
