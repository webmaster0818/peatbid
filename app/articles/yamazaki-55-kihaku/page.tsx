...
export const metadata: Metadata = {
  title: '山崎55年の希少性と買取・投資価値【2026年8月最新】保有か売却かの判断軸',
  description: '山崎55年の希少性ランクと投資対象としての評価を徹底分析。価格推移、需給動向、長期保有 vs 売却の判断基準、税制優遇まで、コレクター向けに解説。',
};
...
export default function Yamazaki55KihakuPage() {
  return (
    <>
      <FaqSchema />
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/yamazaki-55.png" alt='山崎55年の希少性と投資価値' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">山崎55年の希少性と投資価値</h1>
          ...
          <p>山崎55年は希少度伝説級クラスのボトル。投資対象として保有すべきか、それとも売却すべきか——コレクターが直面する判断を、データと市場動向から考察します。</p>
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>山崎55年は希少度カテゴリで「<strong>伝説級</strong>」に分類されます。希少度は以下の4要素で決まります:</p><ol><li>生産終了・休売の有無</li><li>市場流通量</li><li>コレクター需要</li><li>国際的評価

希少度が高いほど、二次流通市場での価格上昇期待が大きくなります。伝説級クラスは、長期保有でプレミアが乗りやすい傾向があります。</li></ol>` }} />

          <h2 id="section-2">3. 価格推移の歴史</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>山崎55年は過去5〜10年にわたって、二次流通市場で価格が上昇基調にあります。特に2018年以降の世界的ジャパニーズウイスキーブーム以降は、長期熟成・終売銘柄を中心に<strong>3〜10倍</strong>の値上がりを記録した銘柄も少なくありません。</p><p>2020年: コロナ禍で一時的に需要減少も、すぐに回復<br/>2021〜2022年: アジア富裕層の参入加速、価格急騰<br/>2023〜2024年: 上昇ペースは緩和、安定推移<br/>2025〜2026年: 円安効果と海外需要継続で高値維持</p><p>この推移を踏まえ、山崎55年の中長期見通しは引き続き堅調と予想されます。</p>` }} />
