...
export const metadata: Metadata = {
  title: '響ジャパニーズハーモニーの希少性と投資価値【2026年完全版】長期保有 vs 売却の判断軸',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>響ジャパニーズハーモニーは希少度現行品クラスのボトルで、現在の買取相場は約14,000円前後。投資対象として保有すべきか、それとも売却すべきか——コレクターが直面する判断を、データと市場動向から考察します。</p>
