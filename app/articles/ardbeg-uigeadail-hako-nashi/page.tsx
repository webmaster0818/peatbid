...
export const metadata: Metadata = {
  title: 'アードベッグ ウーガダールが箱なしでも買取できる？【2026年完全版】査定額への影響と代替戦略',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-hibiki.png" alt='アードベッグ ウーガダールが箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>アードベッグ ウーガダールの場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 14,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 11,900円〜13,300円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 11,900円〜12,880円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 11,200円〜12,600円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 10,500円〜11,900円（75〜85%）
