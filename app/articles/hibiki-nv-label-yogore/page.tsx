...
export const metadata: Metadata = {
  title: '響ジャパニーズハーモニーはラベル汚れ・破れでも売れる?【2026年9月最新】状態別の買取査定額',
  description: '響ジャパニーズハーモニーのラベル汚れ・破れ・剥がれ・水濡れ跡がある場合の買取査定額を詳細解説。状態別の価格目安、ラベル保護の保管方法、業者選定まで完全ガイド。',
};
...
export default function HibikiNvLabelYogorePage() {
  return (
    <>
      <FaqSchema />
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/hibiki-nv.png" alt='響ジャパニーズハーモニーのラベル汚れ・破れがあっても売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">響ジャパニーズハーモニーのラベル汚れ・破れがあっても売れる？</h1>
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-2" className="hover:underline">3. ラベル状態別の査定額目安（響ジャパニーズハーモニー）</a></li>
          ...
          <p>長期保管した響ジャパニーズハーモニーのラベルが汚れた、破れた、水濡れ跡がついた——そんな場合でも、買取は可能です。本記事では、ラベルの状態が査定額にどう影響するか、状態別の価格目安と対処法を完全解説します。</p>
          ...
          <h2 id="section-2">3. ラベル状態別の査定額目安（響ジャパニーズハーモニー）</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>響ジャパニーズハーモニーの実勢中央値<strong>10,779円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 10,779円（100%）</li><li><strong>軽度の汚れ</strong>: 約9,700円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約8,620円（80%程度）</li><li><strong>破れ・欠け</strong>: 約7,010円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約5,390円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約4,310円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約2,160円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
