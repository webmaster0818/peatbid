    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響ジャパニーズハーモニーの基準価格 14,000円に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 14,000円（100%）</li><li><strong>軽度の汚れ</strong>: 12,600円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 11,200円（80%程度）</li><li><strong>破れ・欠け</strong>: 9,100円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 7,000円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 5,600円（40%程度）</li><li><strong>ラベル完全消失</strong>: 2,800円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
