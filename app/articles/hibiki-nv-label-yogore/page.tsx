    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響ジャパニーズハーモニーの基準価格 15,000円に対し、ラベル状態でこう変動します:<br/>- <strong>新品同様</strong>: 15,000円（100%）<br/>- <strong>軽度の汚れ</strong>: 13,500円（90%程度）<br/>- <strong>シミ・水濡れ跡</strong>: 12,000円（80%程度）<br/>- <strong>破れ・欠け</strong>: 9,750円（65%程度）<br/>- <strong>強い退色・大きな損傷</strong>: 7,500円（50%程度）</p>` }} />
