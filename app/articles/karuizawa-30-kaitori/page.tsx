...
export const metadata: Metadata = {
  title: '軽井沢30年の買取相場ガイド【2026年6月最新】Yahoo中央値ベース',
  description: '軽井沢30年（Karuizawa 30 Year）の買取相場の最新目安（Yahoo Auctions 過去180日落札中央値ベース）。箱なし・開封済み等の状態別目安、買取業者4社の比較、高く売るコツ、贋作リスクまで網羅。売却検討者必読の決定版ガイド。',
};
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">軽井沢30年の買取相場と業者比較ガイド【2026年6月】</h1>
