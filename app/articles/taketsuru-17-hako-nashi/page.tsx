...
export const metadata: Metadata = {
  title: '竹鶴17年が箱なしでも買取できる？【2026年完全版】査定額への影響と代替戦略',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴17年の場合、実勢中央値<strong>33,012円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 33,012円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約28,060〜31,360円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約28,060〜30,370円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約26,410〜29,710円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約24,760〜28,060円（75〜85%）
