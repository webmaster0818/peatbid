...
export const metadata: Metadata = {
  title: '竹鶴17年は箱なしでも買取できる?【2026年8月最新】査定額への影響と対策',
  description: '竹鶴17年を箱なしで売る場合の査定額への影響と買取依頼時の注意点。査定額の目安、代替戦略、賢い売却法、箱を探す方法まで完全解説。',
};
...
export default function Taketsuru17HakoNashiPage() {
  return (
    <>
      <FaqSchema />
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/taketsuru-17.png" alt='竹鶴17年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">竹鶴17年が箱なしでも買取できる？</h1>
          ...
          <p>「外箱を捨ててしまった」「最初から箱なしで購入した」——そんな状況でも、竹鶴17年の買取は可能です。ただし、付属品の有無で査定額は大きく変動します。本記事では、箱なしの場合の影響と賢い売却法を完全解説します。</p>
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴17年の場合、実勢中央値<strong>32,998円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 32,998円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約28,050〜31,350円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約28,050〜30,360円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約26,400〜29,700円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約24,750〜28,050円（75〜85%）
...
本物の外箱が見つからない場合は、箱なしで正直に売却するのが正解です。</li></ol>` }} />
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>一部のコレクター・買取業者は、空き箱を単体で販売することがあります。<strong>入手経路</strong>:</p><ol><li><strong>メルカリ・ヤフオク</strong> — 「竹鶴17年 箱」で検索</li><li><strong>海外オークション</strong> — Whisky Auctioneerなどで稀に出品</li><li><strong>コレクターSNS</strong> — Twitter・Instagramで交換相手を探す</li><li><strong>ウイスキー専門店</strong> — 店舗に在庫がある場合あり
