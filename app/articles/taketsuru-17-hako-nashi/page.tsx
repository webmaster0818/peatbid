...
export const metadata: Metadata = {
  title: '竹鶴17年は箱なしでも買取できる?【2026年9月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴17年の場合、実勢中央値<strong>32,500円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 32,500円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約27,620〜30,880円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約27,620〜29,900円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約26,000〜29,250円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約24,380〜27,620円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約8,120円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
