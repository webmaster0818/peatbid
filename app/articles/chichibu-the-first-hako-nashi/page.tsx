    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>秩父ザファーストの場合、実勢中央値<strong>95,100円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 95,100円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約80,840〜90,340円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約80,840〜87,490円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約76,080〜85,590円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約71,320〜80,840円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約23,780円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
