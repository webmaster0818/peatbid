    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>秩父ザファーストの場合、実勢中央値<strong>94,490円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 94,490円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約80,320〜89,770円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約80,320〜86,930円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約75,590〜85,040円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約70,870〜80,320円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約23,620円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
