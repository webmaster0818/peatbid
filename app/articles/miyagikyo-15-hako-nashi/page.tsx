...
export const metadata: Metadata = {
  title: '宮城峡15年は箱なしでも買取できる?【2026年6月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>宮城峡15年の場合、実勢中央値<strong>67,100円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 67,100円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約57,040〜63,740円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約57,040〜61,730円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約53,680〜60,390円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約50,320〜57,040円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約16,780円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
