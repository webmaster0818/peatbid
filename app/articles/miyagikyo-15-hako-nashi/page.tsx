...
export const metadata: Metadata = {
  title: '宮城峡15年が箱なしでも買取できる？【2026年完全版】査定額への影響と代替戦略',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>宮城峡15年の場合、実勢中央値<strong>64,999円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 64,999円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約55,250〜61,750円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約55,250〜59,800円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約52,000〜58,500円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約48,750〜55,250円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約16,250円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
