...
export const metadata: Metadata = {
  title: '秩父ザファーストはラベル汚れ・破れでも売れる?【2026年8月最新】状態別の買取査定額',
  description: '秩父ザファーストのラベル汚れ・破れ・剥がれ・水濡れ跡がある場合の買取査定額を詳細解説。状態別の価格目安、ラベル保護の保管方法、業者選定まで完全ガイド。',
};
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/chichibu-the-first.png" alt='秩父ザファーストのラベル汚れ・破れがあっても売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-2" className="hover:underline">3. ラベル状態別の査定額目安（秩父ザファースト）</a></li>
          ...
          <p>長期保管した秩父ザファーストのラベルが汚れた、破れた、水濡れ跡がついた——そんな場合でも、買取は可能です。本記事では、ラベルの状態が査定額にどう影響するか、状態別の価格目安と対処法を完全解説します。</p>
          ...
          <h2 id="section-2">3. ラベル状態別の査定額目安（秩父ザファースト）</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>秩父ザファーストの実勢中央値<strong>89,600円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 89,600円（100%）</li><li><strong>軽度の汚れ</strong>: 約80,640円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約71,680円（80%程度）</li><li><strong>破れ・欠け</strong>: 約58,240円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約44,800円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約35,840円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約17,920円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
