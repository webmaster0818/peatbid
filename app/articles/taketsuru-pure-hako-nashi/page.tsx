    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴ピュアモルトの場合、実勢中央値<strong>13,000円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 13,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約11,050〜12,350円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約11,050〜11,960円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約10,400〜11,700円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約9,750〜11,050円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約3,250円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
