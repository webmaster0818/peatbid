    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴ピュアモルトの場合、実勢中央値<strong>8,500円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 8,500円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約7,220〜8,080円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約7,220〜7,820円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約6,800〜7,650円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約6,380〜7,220円（75〜85%）
