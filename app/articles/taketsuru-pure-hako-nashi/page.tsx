    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴ピュアモルトの場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 13,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 11,050円〜12,350円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 11,050円〜11,960円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 10,400円〜11,700円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 9,750円〜11,050円（75〜85%）

つまり、最大で<strong>約25%（3,250円）の差</strong>が生じる可能性があります。</li></ol>` }} />
