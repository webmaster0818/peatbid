    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-hibiki.png" alt='アードベッグ ウーガダールが開封済みでも売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              <li><a href="#section-0" className="hover:underline">1. 開封済みアードベッグ ウーガダールの査定額の目安</a></li>
          ...
          <h2 id="section-0">1. 開封済みアードベッグ ウーガダールの査定額の目安</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きが基準価格約12,000円に対し、開封済みは状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 基準の30〜40%（3,600円〜4,800円）</li><li><strong>7割以上残</strong>: 基準の25〜35%（3,000円〜4,200円）</li><li><strong>5割以上残</strong>: 基準の20〜30%（2,400円〜3,600円）</li><li><strong>3割以上残</strong>: 基準の10〜20%</li><li><strong>1割以下残</strong>: 買取拒否の場合あり、もしくは空ボトルとして数千円</li></ol>` }} />
