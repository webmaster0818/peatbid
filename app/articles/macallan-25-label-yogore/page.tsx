    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-hibiki.png" alt='マッカラン25年のラベル汚れ・破れがあっても売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-1" className="hover:underline">2. ラベル状態別の査定額目安（マッカラン25年）</a></li>
          ...
          <h2 id="section-1">2. ラベル状態別の査定額目安（マッカラン25年）</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン25年の基準価格 400,000円に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 400,000円（100%）</li><li><strong>軽度の汚れ</strong>: 360,000円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 320,000円（80%程度）</li><li><strong>破れ・欠け</strong>: 260,000円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 200,000円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 160,000円（40%程度）</li><li><strong>ラベル完全消失</strong>: 80,000円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
