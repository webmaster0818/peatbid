...
export const metadata: Metadata = {
  title: 'マッカラン25年はラベル汚れ・破れでも売れる?【2026年8月最新】状態別の買取査定額',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン25年の実勢中央値<strong>200,000円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 200,000円（100%）</li><li><strong>軽度の汚れ</strong>: 約180,000円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約160,000円（80%程度）</li><li><strong>破れ・欠け</strong>: 約130,000円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約100,000円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約80,000円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約40,000円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
