    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン25年の実勢中央値<strong>176,277円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 176,277円（100%）</li><li><strong>軽度の汚れ</strong>: 約158,650円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約141,020円（80%程度）</li><li><strong>破れ・欠け</strong>: 約114,580円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約88,140円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約70,510円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約35,260円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
