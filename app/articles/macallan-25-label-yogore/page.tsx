    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン25年の実勢中央値<strong>181,000円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 181,000円（100%）</li><li><strong>軽度の汚れ</strong>: 約162,900円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約144,800円（80%程度）</li><li><strong>破れ・欠け</strong>: 約117,650円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約90,500円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約72,400円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約36,200円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
