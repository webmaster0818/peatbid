    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>余市15年の基準価格 42,000円に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 42,000円（100%）</li><li><strong>軽度の汚れ</strong>: 37,800円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 33,600円（80%程度）</li><li><strong>破れ・欠け</strong>: 27,300円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 21,000円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 16,800円（40%程度）</li><li><strong>ラベル完全消失</strong>: 8,400円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
