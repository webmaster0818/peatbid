...
export const metadata: Metadata = {
  title: "マッカラン12年のオークション相場推移【2026年最新】Sotheby's/Bonhams/海外オークション落札データ",
  description: "マッカラン12年の国内外オークション相場推移を徹底分析。Sotheby's・Bonhams・Whisky Auctioneerの落札データから読み解く価格動向と今後の見通し。",
};

function FaqSchema() {
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{ "@type": "Question", "name": 'マッカラン12年は国内と海外、どちらで売る方が高い？', "acceptedAnswer": { "@type": "Answer", "text": 'ボトルとタイミングによりますが、高額銘柄は海外オークション経由で高値がつくケースが多数。ただし国際輸送・関税・代行業者手数料を考慮した手取り比較が必要です。' } }, { "@type": "Question", "name": 'オークションでの落札価格は誰が見れる？', "acceptedAnswer": { "@type": "Answer", "text": "Sotheby's、Bonhams、Whisky Auctioneer等は公式サイトで Past Results を公開。月額有料サービス（Whisky Stats等）はより詳細なデータを提供しています。" } }, { "@type": "Question", "name": '個人でも海外オークションに出品できる？', "acceptedAnswer": { "@type": "Answer", "text": '可能ですが、酒類の国際輸送ライセンス・手数料・送料が発生します。国内買取業者経由の方が手続き面で簡単です。' } }] }) }} />;
}
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン12年の二次流通価格は、過去5年で大きく上昇しています。2020〜2026年にかけて、ジャパニーズウイスキーは世界的需要拡大により価格が継続上昇。現在の参考買取価格は約15,000円前後で推移しています。</p>` }} />
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン12年の中長期見通しは、(1)世界的需要の継続、(2)供給制限、(3)新興市場の参入 の3要因が支え、高値推移が予想されます。ただし短期は需給の振れにより上下動も発生します。</p>` }} />
