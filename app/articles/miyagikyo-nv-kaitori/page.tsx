...
export const metadata: Metadata = {
  title: '宮城峡ノンエイジの買取相場ガイド【2026年6月最新】Yahoo中央値ベース',
  description: '宮城峡ノンエイジ（Miyagikyo NV）の買取相場の最新目安（Yahoo Auctions 過去180日落札中央値ベース）。箱なし・開封済み等の状態別目安、買取業者4社の比較、高く売るコツ、贋作リスクまで網羅。売却検討者必読の決定版ガイド。',
};
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">宮城峡ノンエイジの買取相場と業者比較ガイド【2026年6月】</h1>
          ...
          <p>宮城峡ノンエイジの市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>市場相場データ蓄積中</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=6件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>
