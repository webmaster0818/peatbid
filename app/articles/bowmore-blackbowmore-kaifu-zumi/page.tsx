...
export const metadata: Metadata = {
  title: 'ブラックボウモアが開封済みでも売れる？【2026年完全版】残量別査定額と賢い売却法',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きの実勢中央値<strong>4,030円</strong>を基準として、開封済みは残量・状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 約1,210〜1,610円（30〜40%）</li><li><strong>7割以上残</strong>: 約1,010〜1,410円（25〜35%）</li><li><strong>5割以上残</strong>: 約810〜1,210円（20〜30%）</li><li><strong>3割以上残</strong>: 約400〜810円（10〜20%）</li><li><strong>1割以下残</strong>: 買取不可の場合あり、もしくは空ボトルとして数千円
