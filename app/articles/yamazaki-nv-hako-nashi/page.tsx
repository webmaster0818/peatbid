...
export const metadata: Metadata = {
  title: '山崎ノンエイジは箱なしでも買取できる?【2026年9月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>山崎ノンエイジの場合、実勢中央値<strong>10,067円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 10,067円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約8,560〜9,560円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約8,560〜9,260円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約8,050〜9,060円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約7,550〜8,560円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約2,520円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
