...
export const metadata: Metadata = {
  title: '余市ノンエイジのラベル汚れ・破れがあっても売れる？【2026年完全版】状態別査定額と保護方法',
  description: '余市ノンエイジのラベル汚れ・破れ・剥がれ・水濡れ跡がある場合の買取査定額を詳細解説。状態別の価格目安、ラベル保護の保管方法、業者選定まで完全ガイド。',
};
...
export default function YoichiNvLabelYogorePage() {
  return (
    <>
      <FaqSchema />
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt='余市ノンエイジのラベル汚れ・破れがあっても売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">余市ノンエイジのラベル汚れ・破れがあっても売れる？</h1>
          ...
          <p>長期保管した余市ノンエイジのラベルが汚れた、破れた、水濡れ跡がついた——そんな場合でも、買取は可能です。本記事では、ラベルの状態が査定額にどう影響するか、状態別の価格目安と対処法を完全解説します。</p>
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>余市ノンエイジの基準価格 18,000円に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 18,000円（100%）</li><li><strong>軽度の汚れ</strong>: 16,200円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 14,400円（80%程度）</li><li><strong>破れ・欠け</strong>: 11,700円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 9,000円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 7,200円（40%程度）</li><li><strong>ラベル完全消失</strong>: 3,600円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
