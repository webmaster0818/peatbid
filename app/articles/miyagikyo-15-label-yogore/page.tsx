    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>宮城峡15年の基準価格 160,000円に対し、ラベル状態でこう変動します:<br/>- <strong>新品同様</strong>: 160,000円（100%）<br/>- <strong>軽度の汚れ</strong>: 144,000円（90%程度）<br/>- <strong>シミ・水濡れ跡</strong>: 128,000円（80%程度）<br/>- <strong>破れ・欠け</strong>: 104,000円（65%程度）<br/>- <strong>強い退色・大きな損傷</strong>: 80,000円（50%程度）</p>` }} />
