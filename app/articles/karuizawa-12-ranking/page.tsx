...
export const metadata: Metadata = {
  title: '軽井沢12年の買取おすすめ業者ランキング【2026年8月最新】査定額・スピードで徹底比較',
  description: '軽井沢12年に強い買取業者をランキング形式で徹底比較。ヒカカク・バイセル・リカスタの査定スピード・査定額・サポート・信頼性を多角的に評価し、目的別おすすめを提示。',
};
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/karuizawa-12.png" alt='軽井沢12年の買取業者おすすめランキング' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <p>軽井沢12年を高く売るには、業者選びが最重要です。実勢中央値76,423円クラスのボトルでも、業者間で概算約3,820〜11,460円（相場の5〜15%）の査定差が生じ得ます。本記事ではPeatBid編集部が選定基準に基づいて選んだ軽井沢12年に強い買取業者4社を、ランキング形式で比較します。</p>
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>PeatBid編集部の軽井沢12年買取業者選定基準（5項目）:</p><ol><li><strong>専門知識</strong> — お酒・ウイスキー専門の鑑定力があるか</li><li><strong>査定スピード</strong> — 見積もり〜入金までの所要日数</li><li><strong>査定額の透明性</strong> — 価格根拠・状態評価の説明があるか</li><li><strong>手数料・キャンセル料</strong> — 完全無料か</li><li><strong>信頼性</strong> — 上場・古物商許可・口コミ評判
