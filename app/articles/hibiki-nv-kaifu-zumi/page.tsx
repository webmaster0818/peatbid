...
export const metadata: Metadata = {
  title: '響ジャパニーズハーモニーは開封済みでも売れる?【2026年9月最新】残量別の買取査定額と売却法',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きの実勢中央値<strong>10,779円</strong>を基準として、開封済みは残量・状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 約3,230〜4,310円（30〜40%）</li><li><strong>7割以上残</strong>: 約2,690〜3,770円（25〜35%）</li><li><strong>5割以上残</strong>: 約2,160〜3,230円（20〜30%）</li><li><strong>3割以上残</strong>: 約1,080〜2,160円（10〜20%）</li><li><strong>1割以下残</strong>: 買取不可の場合あり、もしくは空ボトルとして数千円
