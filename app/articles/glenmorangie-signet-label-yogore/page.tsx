    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>グレンモーレンジ シグネットの基準価格 32,000円に対し、ラベル状態でこう変動します:<br/>- <strong>新品同様</strong>: 32,000円（100%）<br/>- <strong>軽度の汚れ</strong>: 28,800円（90%程度）<br/>- <strong>シミ・水濡れ跡</strong>: 25,600円（80%程度）<br/>- <strong>破れ・欠け</strong>: 20,800円（65%程度）<br/>- <strong>強い退色・大きな損傷</strong>: 16,000円（50%程度）</p>` }} />
