    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt='イチローズモルト ダブルディスティラリーズのラベル汚れ・破れがあっても売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>イチローズモルト ダブルディスティラリーズの基準価格 120,000円に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 120,000円（100%）</li><li><strong>軽度の汚れ</strong>: 108,000円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 96,000円（80%程度）</li><li><strong>破れ・欠け</strong>: 78,000円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 60,000円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 48,000円（40%程度）</li><li><strong>ラベル完全消失</strong>: 24,000円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
