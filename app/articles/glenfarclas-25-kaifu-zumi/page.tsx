    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きが基準価格約19,000円に対し、開封済みは状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 基準の30〜40%（5,700円〜7,600円）</li><li><strong>7割以上残</strong>: 基準の25〜35%（4,750円〜6,650円）</li><li><strong>5割以上残</strong>: 基準の20〜30%（3,800円〜5,700円）</li><li><strong>3割以上残</strong>: 基準の10〜20%</li><li><strong>1割以下残</strong>: 買取拒否の場合あり、もしくは空ボトルとして数千円</li></ol>` }} />
