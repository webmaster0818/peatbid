...
export const metadata: Metadata = {
  title: '余市10年は箱なしでも買取できる?【2026年6月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>余市10年の場合、実勢中央値<strong>22,525円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 22,525円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約19,150〜21,400円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約19,150〜20,720円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約18,020〜20,270円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約16,890〜19,150円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約5,630円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
