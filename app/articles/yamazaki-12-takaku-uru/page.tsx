...
export const metadata: Metadata = {
  title: '山崎12年を高く売るには？買取相場と査定額を最大化する7つのコツ【2026年7月最新】',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>山崎12年の査定では、外箱・冊子・カートン・ホログラムシールの有無で<strong>査定額が10〜20%変動</strong>します。実勢中央値<strong>20,350円</strong>を基準とすると、付属品なしでは約16,280〜18,320円（相場の80〜90%）まで下がるのが一般的です。</p><p>外箱にシミ・破れ・水濡れ跡があると更に-5〜10%。付属品を揃えるだけで約3,050円前後の差が出る計算です。</p><p>まず家中を徹底的に探し、すべての付属品を集めてから売却を検討してください。</p>` }} />

          <h2 id="section-2">3. コツ2: 未開封の状態を維持</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>山崎12年は開封済みになると査定額が大幅に下がり、未開封の30〜40%＝約6,100〜8,140円前後まで落ちます。未開封なら20,350円前後で売れる可能性があることを考えると、その差は歴然です。</p><p>コレクション目的のボトルは絶対に開けず保管を。「ちょっと味見」が大きな損失につながります。</p><p>万一開封した場合は、香味揮発・酸化が進む前にできるだけ早く売却するのが鉄則です。</p>` }} />
