    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>2026年5月現在、マルス駒ヶ岳（未開封・箱付き）の買取相場は<strong>約12,000円前後</strong>。希少度は<strong>コモン</strong>クラスに位置し、現行品として安定流通しているが、銘柄によってはプレミア化の兆しあり。市場価値は中位だが、コレクター入門品として安定需要を持つ。</p>
          ...
          <p>2026年5月時点でのマルス駒ヶ岳の買取相場は<strong>10,200円〜12,000円</strong>のレンジで推移しています（未開封・箱付きの場合）。この相場は、以下の市場データの集約から算出しています:</p>
