    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt='竹鶴21年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>竹鶴21年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 380,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 323,000円〜361,000円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 323,000円〜349,600円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 304,000円〜342,000円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 285,000円〜323,000円（75〜85%）

つまり、最大で<strong>約25%（95,000円）の差</strong>が生じる可能性があります。</li></ol>` }} />
