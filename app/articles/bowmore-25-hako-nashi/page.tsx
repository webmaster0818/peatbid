    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-hibiki.png" alt='ボウモア25年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <p>「外箱を捨ててしまった」「最初から箱なしで購入した」——そんな状況でも、ボウモア25年の買取は可能です。ただし、付属品の有無で査定額は大きく変動します。本記事では、箱なしの場合の影響と賢い売却法を解説します。</p>

          <h2>箱なしによる査定額の影響</h2>

          <div dangerouslySetInnerHTML={{ __html: `<p>ボウモア25年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:<br/>- <strong>箱・冊子・カートン揃い</strong>: 基準価格 150,000円<br/>- <strong>箱なし、ラベル良好</strong>: 120,000円〜135,000円<br/>- <strong>箱なし、冊子なし</strong>: 112,500円〜127,500円</p>` }} />
          ...
          <div className="space-y-3 not-prose">
            {[{ q: '箱を捨ててしまったボウモア25年でも売れる？', a: 'はい、売れます。査定額は10〜20%下がりますが、未開封でラベル状態が良ければ十分な価格がつきます。' }, { q: '代用品の箱（汎用箱）を作って売却するのは？', a: '正規品でない箱は査定額に影響しません。むしろ正規品でない外箱は混乱を招くため、添付しない方が良いです。' }, { q: 'ホログラムシールが箱だけにある場合は？', a: 'ホログラムシールがボトルにも貼られている場合は問題なし。ただし、確認方法は業者により異なるため、事前に相談しましょう。' }].map((faq) => (
