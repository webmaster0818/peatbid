...
export const metadata: Metadata = {
  title: 'ボウモア25年が箱なしでも買取できる？【2026年完全版】査定額への影響と代替戦略',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>ボウモア25年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 69,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 58,650円〜65,550円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 58,650円〜63,480円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 55,200円〜62,100円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 51,750円〜58,650円（75〜85%）

つまり、最大で<strong>約25%（17,250円）の差</strong>が生じる可能性があります。</li></ol>` }} />
