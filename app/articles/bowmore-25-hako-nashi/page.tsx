    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>ボウモア25年の場合、実勢中央値<strong>67,499円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 67,499円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約57,370〜64,120円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約57,370〜62,100円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約54,000〜60,750円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約50,620〜57,370円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約16,870円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
