...
export const metadata: Metadata = {
  title: '宮城峡15年は開封済みでも売れる?【2026年6月最新】残量別の買取査定額と売却法',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きの実勢中央値<strong>64,999円</strong>を基準として、開封済みは残量・状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 約19,500〜26,000円（30〜40%）</li><li><strong>7割以上残</strong>: 約16,250〜22,750円（25〜35%）</li><li><strong>5割以上残</strong>: 約13,000〜19,500円（20〜30%）</li><li><strong>3割以上残</strong>: 約6,500〜13,000円（10〜20%）</li><li><strong>1割以下残</strong>: 買取不可の場合あり、もしくは空ボトルとして数千円
