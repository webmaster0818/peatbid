...
export const metadata: Metadata = {
  title: 'マッカラン30年の買取おすすめ業者ランキング【2026年9月最新】査定額・スピードで徹底比較',
  description: 'マッカラン30年に強い買取業者をランキング形式で徹底比較。ヒカカク・バイセル・リカスタの査定スピード・査定額・サポート・信頼性を多角的に評価し、目的別おすすめを提示。',
};
...
export default function Macallan30RankingPage() {
  return (
    <>
      <FaqSchema />
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/macallan-30.png" alt='マッカラン30年の買取業者おすすめランキング' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">マッカラン30年の買取業者おすすめランキング</h1>
          ...
          <p>マッカラン30年を高く売るには、業者選びが最重要です。実勢中央値351,000円クラスのボトルでも、業者間で概算約17,550〜52,650円（相場の5〜15%）の査定差が生じ得ます。本記事ではPeatBid編集部が選定基準に基づいて選んだマッカラン30年に強い買取業者4社を、ランキング形式で比較します。</p>
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>PeatBid編集部のマッカラン30年買取業者選定基準（5項目）:</p><ol><li><strong>専門知識</strong> — お酒・ウイスキー専門の鑑定力があるか</li><li><strong>査定スピード</strong> — 見積もり〜入金までの所要日数</li><li><strong>査定額の透明性</strong> — 価格根拠・状態評価の説明があるか</li><li><strong>手数料・キャンセル料</strong> — 完全無料か</li><li><strong>信頼性</strong> — 上場・古物商許可・口コミ評判
