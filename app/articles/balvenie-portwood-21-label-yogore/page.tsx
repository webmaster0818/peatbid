...
export const metadata: Metadata = {
  title: 'バルヴェニー ポートウッド 21年はラベル汚れ・破れでも売れる?【2026年6月最新】状態別の買取査定額',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/balvenie-portwood-21.png" alt='バルヴェニー ポートウッド 21年のラベル汚れ・破れがあっても売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-2" className="hover:underline">3. ラベル状態別の査定額目安（バルヴェニー ポートウッド 21年）</a></li>
          ...
          <h2 id="section-2">3. ラベル状態別の査定額目安（バルヴェニー ポートウッド 21年）</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>バルヴェニー ポートウッド 21年の実勢中央値<strong>31,425円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 31,425円（100%）</li><li><strong>軽度の汚れ</strong>: 約28,280円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約25,140円（80%程度）</li><li><strong>破れ・欠け</strong>: 約20,430円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約15,710円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約12,570円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約6,280円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
