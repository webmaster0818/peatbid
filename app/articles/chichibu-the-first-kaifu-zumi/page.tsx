    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>未開封・箱付きが基準価格約350万円に対し、開封済みは状態により以下のレンジで査定されます:
- **9割以上残**: 基準の30〜40%（105万円〜140万円）
- **半分以上残**: 基準の20〜30%（700,000円〜105万円）
...
5. **キャップ・栓の状態**: しっかり閉まっているか</p>
          ...
          <p>以下のような秩父ザファーストは、開封済みでも高めの査定が期待できます:
- 終売・希少銘柄（流通量が極小）
- 古いボトリング（ヴィンテージ価値）
- 外箱・冊子が完全保存
- 残量が9割以上で蓋がしっかり閉まっている</p>
          ...
          <p>開封後の秩父ザファーストは、なるべく早く売却するか、適切に保管しましょう:
- 立てて保管（横置きはコルク劣化）
- 直射日光なし、室温20℃以下
- できれば未開封同等の場所で
- 売却まで開けない、注ぎ足しはしない</p>
