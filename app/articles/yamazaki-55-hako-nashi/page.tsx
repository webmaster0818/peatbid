    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt='山崎55年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>山崎55年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 3,000万円（100%）</li><li><strong>箱あり・冊子なし</strong>: 2,550万円〜2,850万円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 2,550万円〜2,760万円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 2,400万円〜2,700万円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 2,250万円〜2,550万円（75〜85%）
