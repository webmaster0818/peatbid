...
export const metadata: Metadata = {
  title: '響ジャパニーズハーモニーは箱なしでも買取できる?【2026年9月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響ジャパニーズハーモニーの場合、実勢中央値<strong>10,779円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 10,779円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約9,160〜10,240円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約9,160〜9,920円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約8,620〜9,700円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約8,080〜9,160円（75〜85%）
