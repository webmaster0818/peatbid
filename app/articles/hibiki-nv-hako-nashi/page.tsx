    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響ジャパニーズハーモニーの場合、実勢中央値<strong>10,726円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 10,726円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約9,120〜10,190円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約9,120〜9,870円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約8,580〜9,650円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約8,040〜9,120円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約2,680円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
