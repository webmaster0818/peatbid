    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>余市20年の実勢中央値<strong>249,361円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 249,361円（100%）</li><li><strong>軽度の汚れ</strong>: 約224,420円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約199,490円（80%程度）</li><li><strong>破れ・欠け</strong>: 約162,080円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約124,680円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約99,740円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約49,870円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
