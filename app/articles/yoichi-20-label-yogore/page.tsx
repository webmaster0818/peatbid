...
export const metadata: Metadata = {
  title: '余市20年はラベル汚れ・破れでも売れる?【2026年7月最新】状態別の買取査定額',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>余市20年の実勢中央値<strong>248,722円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 248,722円（100%）</li><li><strong>軽度の汚れ</strong>: 約223,850円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約198,980円（80%程度）</li><li><strong>破れ・欠け</strong>: 約161,670円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約124,360円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約99,490円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約49,740円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
