    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>余市20年の実勢中央値<strong>250,861円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 250,861円（100%）</li><li><strong>軽度の汚れ</strong>: 約225,770円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約200,690円（80%程度）</li><li><strong>破れ・欠け</strong>: 約163,060円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約125,430円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約100,340円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約50,170円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
