...
export const metadata: Metadata = {
  title: '白州25年が箱なしでも買取できる？【2026年完全版】査定額への影響と代替戦略',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt='白州25年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>白州25年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 950,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 807,500円〜902,500円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 807,500円〜874,000円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 760,000円〜855,000円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 712,500円〜807,500円（75〜85%）

つまり、最大で<strong>約25%（237,500円）の差</strong>が生じる可能性があります。</li></ol>` }} />
