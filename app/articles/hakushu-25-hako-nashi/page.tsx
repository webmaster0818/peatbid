    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>白州25年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 64,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 54,400円〜60,800円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 54,400円〜58,880円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 51,200円〜57,600円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 48,000円〜54,400円（75〜85%）

つまり、最大で<strong>約25%（16,000円）の差</strong>が生じる可能性があります。</li></ol>` }} />
