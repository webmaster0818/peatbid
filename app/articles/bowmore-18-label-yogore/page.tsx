        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-1" className="hover:underline">2. ラベル状態別の査定額目安（ボウモア18年）</a></li>
          ...
          <h2 id="section-1">2. ラベル状態別の査定額目安（ボウモア18年）</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>ボウモア18年の基準価格 38,000円に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 38,000円（100%）</li><li><strong>軽度の汚れ</strong>: 34,200円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 30,400円（80%程度）</li><li><strong>破れ・欠け</strong>: 24,700円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 19,000円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 15,200円（40%程度）</li><li><strong>ラベル完全消失</strong>: 7,600円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
