    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>ボウモア18年の基準価格 18,000円に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 18,000円（100%）</li><li><strong>軽度の汚れ</strong>: 16,200円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 14,400円（80%程度）</li><li><strong>破れ・欠け</strong>: 11,700円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 9,000円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 7,200円（40%程度）</li><li><strong>ラベル完全消失</strong>: 3,600円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
