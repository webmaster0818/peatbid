...
export const metadata: Metadata = {
  title: '山崎12年の希少性と投資価値【2026年完全版】長期保有 vs 売却の判断軸',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt='山崎12年の希少性と投資価値' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <p>山崎12年は希少度終売プレミアクラスのボトルで、現在の買取相場は約20,000円前後。投資対象として保有すべきか、それとも売却すべきか——コレクターが直面する判断を、データと市場動向から考察します。</p>
