    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>余市15年の場合、実勢中央値<strong>80,150円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 80,150円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約68,130〜76,140円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約68,130〜73,740円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約64,120〜72,140円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約60,110〜68,130円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約20,040円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
