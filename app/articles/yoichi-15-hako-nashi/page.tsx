    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt='余市15年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>余市15年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 180,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 153,000円〜171,000円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 153,000円〜165,600円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 144,000円〜162,000円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 135,000円〜153,000円（75〜85%）

つまり、最大で<strong>約25%（45,000円）の差</strong>が生じる可能性があります。</li></ol>` }} />
