...
export const metadata: Metadata = {
  title: '軽井沢12年は箱なしでも買取できる?【2026年8月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>軽井沢12年の場合、実勢中央値<strong>76,423円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 76,423円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約64,960〜72,600円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約64,960〜70,310円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約61,140〜68,780円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約57,320〜64,960円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約19,110円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
