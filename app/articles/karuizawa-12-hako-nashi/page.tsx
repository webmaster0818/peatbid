...
export const metadata: Metadata = {
  title: '軽井沢12年は箱なしでも買取できる?【2026年9月最新】査定額への影響と対策',
  description: '軽井沢12年を箱なしで売る場合の査定額への影響と買取依頼時の注意点。査定額の目安、代替戦略、賢い売却法、箱を探す方法まで完全解説。',
};
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/karuizawa-12.png" alt='軽井沢12年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <p>「外箱を捨ててしまった」「最初から箱なしで購入した」——そんな状況でも、軽井沢12年の買取は可能です。ただし、付属品の有無で査定額は大きく変動します。本記事では、箱なしの場合の影響と賢い売却法を完全解説します。</p>
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>軽井沢12年の場合、実勢中央値<strong>76,975円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 76,975円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約65,430〜73,130円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約65,430〜70,820円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約61,580〜69,280円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約57,730〜65,430円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約19,240円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
...
本物の外箱が見つからない場合は、箱なしで正直に売却するのが正解です。</li></ol>` }} />
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>一部のコレクター・買取業者は、空き箱を単体で販売することがあります。<strong>入手経路</strong>:</p><ol><li><strong>メルカリ・ヤフオク</strong> — 「軽井沢12年 箱」で検索</li><li><strong>海外オークション</strong> — Whisky Auctioneerなどで稀に出品</li><li><strong>コレクターSNS</strong> — Twitter・Instagramで交換相手を探す</li><li><strong>ウイスキー専門店</strong> — 店舗に在庫がある場合あり
