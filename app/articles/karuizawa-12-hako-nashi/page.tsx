    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>軽井沢12年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:<br/>- <strong>箱・冊子・カートン揃い</strong>: 基準価格 150万円<br/>- <strong>箱なし、ラベル良好</strong>: 120万円〜135万円<br/>- <strong>箱なし、冊子なし</strong>: 112万円〜127万円</p>` }} />
