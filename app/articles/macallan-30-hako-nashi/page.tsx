...
export const metadata: Metadata = {
  title: 'マッカラン30年は箱なしでも買取できる?【2026年8月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン30年の場合、実勢中央値<strong>328,500円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 328,500円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約279,220〜312,080円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約279,220〜302,220円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約262,800〜295,650円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約246,380〜279,220円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約82,120円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
