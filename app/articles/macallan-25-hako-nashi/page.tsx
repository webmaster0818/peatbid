    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン25年の場合、実勢中央値<strong>190,000円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 190,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約161,500〜180,500円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約161,500〜174,800円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約152,000〜171,000円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約142,500〜161,500円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約47,500円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
