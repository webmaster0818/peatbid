...
export const metadata: Metadata = {
  title: 'マッカラン25年は箱なしでも買取できる?【2026年9月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン25年の場合、実勢中央値<strong>199,999円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 199,999円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約170,000〜190,000円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約170,000〜184,000円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約160,000〜180,000円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約150,000〜170,000円（75〜85%）
