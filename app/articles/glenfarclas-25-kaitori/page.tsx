    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">グレンファークラス25年の買取相場と業者比較ガイド【2026年9月】</h1>
          ...
          <div className="table-wrapper">
            <table>
              <tbody>
                ...
                <tr><td><strong>市場相場（Yahoo中央値）</strong></td><td><strong>24,100円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>グレンファークラス25年の市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>24,100円</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=92件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="グレンファークラス25年のヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,155.1 116.5,154.6 167.1,155.1 217.6,154.0 268.2,133.7 318.7,154.0 369.3,102.6 419.8,83.0 470.4,38.9 520.9,53.5 571.5,63.2 622.0,58.4" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 22,110円（サンプル n=110件）</title></circle>
              <circle cx="116.5" cy="154.6" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 22,121円（サンプル n=108件）</title></circle>
              <circle cx="167.1" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 22,110円（サンプル n=110件）</title></circle>
              <circle cx="217.6" cy="154.0" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 22,132円（サンプル n=106件）</title></circle>
              <circle cx="268.2" cy="133.7" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-20: 22,550円（サンプル n=102件）</title></circle>
              <circle cx="318.7" cy="154.0" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-27: 22,132円（サンプル n=102件）</title></circle>
              <circle cx="369.3" cy="102.6" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-03: 23,189円（サンプル n=96件）</title></circle>
              <circle cx="419.8" cy="83.0" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-10: 23,593円（サンプル n=98件）</title></circle>
              <circle cx="470.4" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-17: 24,500円（サンプル n=94件）</title></circle>
              <circle cx="520.9" cy="53.5" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-24: 24,200円（サンプル n=90件）</title></circle>
              <circle cx="571.5" cy="63.2" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-31: 24,000円（サンプル n=94件）</title></circle>
              <circle cx="622.0" cy="58.4" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-09-07: 24,100円（サンプル n=92件）</title></circle>
              <text x="618.0" y="48.4" fontSize="11" fontWeight="bold" fill="#8A5A18" textAnchor="end">24,100円</text>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-06-22〜2026-09-07（週次12点・各点のサンプル数 n=90〜110件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
          ...
          <div className="table-wrapper">
            <table>
              ...
              <tbody>
                <tr><td>未開封・完璧</td><td>箱・冊子・カートン揃い</td><td>市場相場の95〜100%程度</td><td><strong>約22,900〜24,100円</strong></td></tr>
                <tr><td>未開封・箱なし</td><td>ラベル良好</td><td>市場相場の80〜90%程度</td><td><strong>約19,280〜21,690円</strong></td></tr>
                <tr><td>未開封・冊子なし</td><td>外箱あり</td><td>市場相場の85〜95%程度</td><td><strong>約20,480〜22,900円</strong></td></tr>
                <tr><td>未開封・ラベル軽度汚れ</td><td>付属あり</td><td>市場相場の75〜88%程度</td><td><strong>約18,080〜21,210円</strong></td></tr>
                <tr><td>未開封・ラベル損傷</td><td>付属あり</td><td>市場相場の60〜75%程度</td><td><strong>約14,460〜18,080円</strong></td></tr>
                <tr><td>未開封・液面減少</td><td>やや進行</td><td>市場相場の55〜70%程度</td><td><strong>約13,260〜16,870円</strong></td></tr>
                <tr><td>開封済み・9割以上残</td><td>付属あり</td><td>市場相場の30〜40%程度</td><td><strong>約7,230〜9,640円</strong></td></tr>
                <tr><td>開封済み・半分以下残</td><td>付属あり</td><td>市場相場の15〜25%程度</td><td><strong>約3,620〜6,020円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>「グレンファークラス25年 買取 箱無し」とお調べの方向けの目安です。未開封・箱なし（ラベル良好）の場合、業界一般の目安は<strong>市場相場の80〜90%程度（約19,280〜21,690円）</strong>。外箱・冊子の揃った完品と比べて1〜2割の減額にとどまるため、<strong>箱がなくても売却を諦める必要はありません</strong>。</p>
