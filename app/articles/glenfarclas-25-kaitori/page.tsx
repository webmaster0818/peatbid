    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div className="table-wrapper">
            <table>
              <tbody>
                ...
                <tr><td><strong>市場相場（Yahoo中央値）</strong></td><td><strong>22,132円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>グレンファークラス25年の市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>22,132円</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=102件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="グレンファークラス25年のヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,155.1 127.8,115.1 189.6,123.5 251.3,81.2 313.1,72.7 374.9,71.9 436.7,72.7 498.4,71.1 560.2,38.9 622.0,71.1" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-05-25: 21,039円（サンプル n=108件）</title></circle>
              <circle cx="127.8" cy="115.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-01: 21,559円（サンプル n=108件）</title></circle>
              <circle cx="189.6" cy="123.5" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-08: 21,450円（サンプル n=110件）</title></circle>
              <circle cx="251.3" cy="81.2" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-15: 22,000円（サンプル n=110件）</title></circle>
              <circle cx="313.1" cy="72.7" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 22,110円（サンプル n=110件）</title></circle>
              <circle cx="374.9" cy="71.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 22,121円（サンプル n=108件）</title></circle>
              <circle cx="436.7" cy="72.7" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 22,110円（サンプル n=110件）</title></circle>
              <circle cx="498.4" cy="71.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 22,132円（サンプル n=106件）</title></circle>
              <circle cx="560.2" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-20: 22,550円（サンプル n=102件）</title></circle>
              <circle cx="622.0" cy="71.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-27: 22,132円（サンプル n=102件）</title></circle>
              <text x="618.0" y="61.1" fontSize="11" fontWeight="bold" fill="#8A5A18" textAnchor="end">22,132円</text>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-05-25〜2026-07-27（週次10点・各点のサンプル数 n=102〜110件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
          ...
          <div className="table-wrapper">
            <table>
              ...
              <tbody>
                <tr><td>未開封・完璧</td><td>箱・冊子・カートン揃い</td><td>市場相場の95〜100%程度</td><td><strong>約21,030〜22,130円</strong></td></tr>
                <tr><td>未開封・箱なし</td><td>ラベル良好</td><td>市場相場の80〜90%程度</td><td><strong>約17,710〜19,920円</strong></td></tr>
                <tr><td>未開封・冊子なし</td><td>外箱あり</td><td>市場相場の85〜95%程度</td><td><strong>約18,810〜21,030円</strong></td></tr>
                <tr><td>未開封・ラベル軽度汚れ</td><td>付属あり</td><td>市場相場の75〜88%程度</td><td><strong>約16,600〜19,480円</strong></td></tr>
                <tr><td>未開封・ラベル損傷</td><td>付属あり</td><td>市場相場の60〜75%程度</td><td><strong>約13,280〜16,600円</strong></td></tr>
                <tr><td>未開封・液面減少</td><td>やや進行</td><td>市場相場の55〜70%程度</td><td><strong>約12,170〜15,490円</strong></td></tr>
          ...
          <p>「グレンファークラス25年 買取 箱無し」とお調べの方向けの目安です。未開封・箱なし（ラベル良好）の場合、業界一般の目安は<strong>市場相場の80〜90%程度（約17,710〜19,920円）</strong>。外箱・冊子の揃った完品と比べて1〜2割の減額にとどまるため、<strong>箱がなくても売却を諦める必要はありません</strong>。</p>
