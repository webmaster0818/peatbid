...
export const metadata: Metadata = {
  title: 'バルヴェニー ポートウッド 21年の希少性と買取・投資価値【2026年7月最新】保有か売却かの判断軸',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>バルヴェニー ポートウッド 21年は希少度終売プレミアクラスのボトル。直近の実勢中央値は約31,500円で、投資対象として保有すべきか、それとも売却すべきか——コレクターが直面する判断を、データと市場動向から考察します。</p>
