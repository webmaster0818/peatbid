...
export const metadata: Metadata = {
  title: '響30年はラベル汚れ・破れでも売れる?【2026年6月最新】状態別の買取査定額',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響30年の実勢中央値<strong>546,700円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 546,700円（100%）</li><li><strong>軽度の汚れ</strong>: 約492,030円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約437,360円（80%程度）</li><li><strong>破れ・欠け</strong>: 約355,360円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約273,350円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約218,680円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約109,340円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
