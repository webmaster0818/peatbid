...
export const metadata: Metadata = {
  title: '響30年のラベル汚れ・破れがあっても売れる？【2026年完全版】状態別査定額と保護方法',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響30年の実勢中央値<strong>548,182円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 548,182円（100%）</li><li><strong>軽度の汚れ</strong>: 約493,360円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約438,550円（80%程度）</li><li><strong>破れ・欠け</strong>: 約356,320円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約274,090円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約219,270円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約109,640円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
