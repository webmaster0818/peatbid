    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>響30年の基準価格 168,000円に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 168,000円（100%）</li><li><strong>軽度の汚れ</strong>: 151,200円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 134,400円（80%程度）</li><li><strong>破れ・欠け</strong>: 109,200円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 84,000円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 67,200円（40%程度）</li><li><strong>ラベル完全消失</strong>: 33,600円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
