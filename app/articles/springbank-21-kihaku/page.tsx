...
export const metadata: Metadata = {
  title: 'スプリングバンク21年の希少性と買取・投資価値【2026年6月最新】保有か売却かの判断軸',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>スプリングバンク21年は希少度高希少クラスのボトル。直近の実勢中央値は約96,798円で、投資対象として保有すべきか、それとも売却すべきか——コレクターが直面する判断を、データと市場動向から考察します。</p>
