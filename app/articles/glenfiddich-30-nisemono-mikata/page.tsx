...
export const metadata: Metadata = {
  title: 'グレンフィディック30年の偽物・贋作の見分け方【2026年最新】コレクター必須の5つのチェックポイント',
  description: 'グレンフィディック30年の偽物・贋作を見分ける具体的なポイントを徹底解説。ラベル・キャップ・液色・ホログラム・購入経路の5要素から本物を確実に判定する方法。',
};

function FaqSchema() {
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{ "@type": "Question", "name": 'グレンフィディック30年に贋作が多いのは本当？', "acceptedAnswer": { "@type": "Answer", "text": 'グレンフィディック30年のような高額銘柄は180,000円前後の流通価格があるため、贋作の経済合理性が成立しやすいです。特に未開封品で高値がつく銘柄は要注意です。' } }, { "@type": "Question", "name": '贋作を売ろうとしたらどうなる？', "acceptedAnswer": { "@type": "Answer", "text": '古物営業法・詐欺罪に問われる可能性があります。買取業者は専門知識で見抜くため、贋作の場合は買取拒否されます。' } }, { "@type": "Question", "name": '怪しいと思ったらどうすればいい？', "acceptedAnswer": { "@type": "Answer", "text": '信頼できる買取業者で**鑑定査定**を依頼してください。お酒買取専門店（JOYLAB等）は本物・贋作の判定経験が豊富です。' } }] }) }} />;
}
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>グレンフィディック30年のような高額ウイスキーは、贋作リスクが高まる銘柄です。特に未開封・箱付きで180,000円前後の流通価格を持つ銘柄は、海外を中心に巧妙な贋作が出回ることもあります。本記事では、グレンフィディック30年の偽物を見抜く具体的なチェックポイントを解説します。</p>
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>本物のグレンフィディック30年は<strong>均一な琥珀色</strong>（透明感あり）。贋作は色ムラ・濁り・沈殿物が見られることがあります。また液面が肩口以下に下がっている古いボトルは要注意。</p>` }} />
          ...
          <div className="space-y-3 not-prose">
            {[{ q: 'グレンフィディック30年に贋作が多いのは本当？', a: 'グレンフィディック30年のような高額銘柄は180,000円前後の流通価格があるため、贋作の経済合理性が成立しやすいです。特に未開封品で高値がつく銘柄は要注意です。' }, { q: '贋作を売ろうとしたらどうなる？', a: '古物営業法・詐欺罪に問われる可能性があります。買取業者は専門知識で見抜くため、贋作の場合は買取拒否されます。' }, { q: '怪しいと思ったらどうすればいい？', a: '信頼できる買取業者で**鑑定査定**を依頼してください。お酒買取専門店（JOYLAB等）は本物・贋作の判定経験が豊富です。' }].map((faq) => (
