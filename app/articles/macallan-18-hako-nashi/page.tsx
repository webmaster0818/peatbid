    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>マッカラン18年の場合、実勢中央値<strong>45,099円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 45,099円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約38,330〜42,840円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約38,330〜41,490円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約36,080〜40,590円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約33,820〜38,330円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約11,270円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
