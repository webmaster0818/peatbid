    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>山崎12年の二次流通価格は、過去5年で大きく上昇しています。2020〜2026年にかけて、ジャパニーズウイスキーは世界的需要拡大により価格が継続上昇。現在の参考買取価格は約38,000円前後で推移しています。</p>` }} />
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>山崎12年の中長期見通しは、(1)世界的需要の継続、(2)供給制限、(3)新興市場の参入 の3要因が支え、高値推移が予想されます。ただし短期は需給の振れにより上下動も発生します。</p>` }} />
