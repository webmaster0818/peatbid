...
export const metadata: Metadata = {
  title: '余市ノンエイジが開封済みでも売れる？【2026年完全版】残量別査定額と賢い売却法',
...
export default function YoichiNvKaifuZumiPage() {
  return (
    <>
      <FaqSchema />
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt='余市ノンエイジが開封済みでも売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
          <div className="article-hero-overlay rounded-xl" />
        </div>

        <article className="prose">
          <h1 className="font-display text-3xl md:text-4xl font-semibold mb-2 !border-none !pb-0 !mt-0">余市ノンエイジが開封済みでも売れる？</h1>
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              <li><a href="#section-0" className="hover:underline">1. 開封済み余市ノンエイジの査定額の目安</a></li>
          ...
          <p>「余市ノンエイジを開けてしまった……もう売れない？」と諦めている方、ご安心ください。開封済みでも、状態と残量次第で買取は可能です。本記事では、開封済みの余市ノンエイジを最大限の価格で売る方法を完全解説します。</p>
          ...
          <h2 id="section-0">1. 開封済み余市ノンエイジの査定額の目安</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>未開封・箱付きが基準価格約18,000円に対し、開封済みは状態により以下のレンジで査定されます:</p><ol><li><strong>9割以上残</strong>: 基準の30〜40%（5,400円〜7,200円）</li><li><strong>7割以上残</strong>: 基準の25〜35%（4,500円〜6,300円）</li><li><strong>5割以上残</strong>: 基準の20〜30%（3,600円〜5,400円）</li><li><strong>3割以上残</strong>: 基準の10〜20%</li><li><strong>1割以下残</strong>: 買取拒否の場合あり、もしくは空ボトルとして数千円</li></ol>` }} />
