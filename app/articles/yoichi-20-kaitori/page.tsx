    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>余市20年の市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>218,185円</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=52件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="余市20年のヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,151.3 158.7,147.5 251.3,38.9 344.0,155.1 436.7,94.2 529.3,147.5 622.0,138.2" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="151.3" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-05-25: 214,071円（サンプル n=60件）</title></circle>
              <circle cx="158.7" cy="147.5" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-01: 215,270円（サンプル n=62件）</title></circle>
              <circle cx="251.3" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-08: 249,361円（サンプル n=56件）</title></circle>
              <circle cx="344.0" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-15: 212,872円（サンプル n=50件）</title></circle>
              <circle cx="436.7" cy="94.2" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 231,996円（サンプル n=48件）</title></circle>
              <circle cx="529.3" cy="147.5" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 215,270円（サンプル n=54件）</title></circle>
              <circle cx="622.0" cy="138.2" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 218,185円（サンプル n=52件）</title></circle>
              <text x="618.0" y="128.2" fontSize="11" fontWeight="bold" fill="#8A5A18" textAnchor="end">218,185円</text>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-05-25〜2026-07-06（週次7点・各点のサンプル数 n=48〜62件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 not-prose">
            ...
            <Link href="/articles/hibiki-21-kaitori/" className="block bg-white border border-warm-border rounded-xl p-4 hover:shadow-md transition-shadow"><span className="text-xs text-amber-dark font-bold">関連銘柄</span><p className="text-sm font-bold mt-1">響21年 の買取相場</p><p className="text-xs text-warm-gray mt-1">市場相場 72,400円</p></Link>
          </div>
