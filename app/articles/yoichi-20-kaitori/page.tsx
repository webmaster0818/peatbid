...
export const metadata: Metadata = {
  title: '【毎週更新】余市20年の買取相場｜ヤフオク落札中央値215,270円基準【2026年8月】',
        ...
        <article className="prose">
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="余市20年のヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,155.1 116.5,96.6 167.1,147.8 217.6,138.8 268.2,38.9 318.7,45.5 369.3,138.8 419.8,151.4 470.4,138.8 520.9,129.9 571.5,147.8 622.0,147.8" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-15: 212,872円（サンプル n=50件）</title></circle>
              <circle cx="116.5" cy="96.6" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-22: 231,996円（サンプル n=48件）</title></circle>
              <circle cx="167.1" cy="147.8" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 215,270円（サンプル n=54件）</title></circle>
              <circle cx="217.6" cy="138.8" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 218,185円（サンプル n=52件）</title></circle>
              <circle cx="268.2" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 250,861円（サンプル n=52件）</title></circle>
              <circle cx="318.7" cy="45.5" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-20: 248,722円（サンプル n=50件）</title></circle>
              <circle cx="369.3" cy="138.8" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-27: 218,185円（サンプル n=36件）</title></circle>
              <circle cx="419.8" cy="151.4" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-03: 214,071円（サンプル n=40件）</title></circle>
              <circle cx="470.4" cy="138.8" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-10: 218,185円（サンプル n=40件）</title></circle>
              <circle cx="520.9" cy="129.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-17: 221,100円（サンプル n=38件）</title></circle>
              <circle cx="571.5" cy="147.8" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-24: 215,270円（サンプル n=46件）</title></circle>
              <circle cx="622.0" cy="147.8" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-31: 215,270円（サンプル n=46件）</title></circle>
              <text x="618.0" y="137.8" fontSize="11" fontWeight="bold" fill="#8A5A18" textAnchor="end">215,270円</text>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-06-15〜2026-08-31（週次12点・各点のサンプル数 n=36〜54件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
