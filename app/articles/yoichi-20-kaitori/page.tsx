    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div className="table-wrapper">
            <table>
              <tbody>
                ...
                <tr><td><strong>市場相場（Yahoo中央値）</strong></td><td><strong>221,100円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>余市20年の市場相場は、本記事冒頭の <strong>市場相場カード</strong> に記載の通り <strong>221,100円</strong> です。これは Yahoo Auctions の過去180日の落札データから IQR 外れ値を除去した上で算出した中央値（n=50件）であり、特定の業者の買取価格ではなく、二次流通市場の実勢値を反映しています。</p>
          ...
          <div className="bg-white border border-warm-border rounded-xl p-5 my-6 not-prose">
            ...
            <svg viewBox="0 0 640 210" role="img" aria-label="余市20年のヤフオク落札中央値の週次推移グラフ" className="w-full h-auto">
              ...
              <polyline points="66.0,151.3 116.5,142.1 167.1,38.9 217.6,45.7 268.2,142.1 318.7,155.1 369.3,142.1 419.8,132.9 470.4,151.3 520.9,151.3 571.5,151.3 622.0,132.9" fill="none" stroke="#C9923D" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
              <circle cx="66.0" cy="151.3" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-06-29: 215,270円（サンプル n=54件）</title></circle>
              <circle cx="116.5" cy="142.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-06: 218,185円（サンプル n=52件）</title></circle>
              <circle cx="167.1" cy="38.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-13: 250,861円（サンプル n=52件）</title></circle>
              <circle cx="217.6" cy="45.7" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-20: 248,722円（サンプル n=50件）</title></circle>
              <circle cx="268.2" cy="142.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-07-27: 218,185円（サンプル n=36件）</title></circle>
              <circle cx="318.7" cy="155.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-03: 214,071円（サンプル n=40件）</title></circle>
              <circle cx="369.3" cy="142.1" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-10: 218,185円（サンプル n=40件）</title></circle>
              <circle cx="419.8" cy="132.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-17: 221,100円（サンプル n=38件）</title></circle>
              <circle cx="470.4" cy="151.3" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-24: 215,270円（サンプル n=46件）</title></circle>
              <circle cx="520.9" cy="151.3" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-08-31: 215,270円（サンプル n=46件）</title></circle>
              <circle cx="571.5" cy="151.3" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-09-07: 215,270円（サンプル n=46件）</title></circle>
              <circle cx="622.0" cy="132.9" r="3.5" fill="#C9923D" stroke="#fff" strokeWidth="1.5"><title>2026-09-14: 221,100円（サンプル n=50件）</title></circle>
              <text x="618.0" y="122.9" fontSize="11" fontWeight="bold" fill="#8A5A18" textAnchor="end">221,100円</text>
            ...
            <p className="text-[11px] text-warm-gray leading-relaxed mt-2">期間 2026-06-29〜2026-09-14（週次12点・各点のサンプル数 n=36〜54件）。出典: ヤフオク実落札データの週次中央値（過去180日・IQR外れ値除去）・毎週月曜自動更新。買取額を保証するものではありません。</p>
          </div>
          ...
          <div className="table-wrapper">
            <table>
              ...
              <tbody>
                <tr><td>未開封・完璧</td><td>箱・冊子・カートン揃い</td><td>市場相場の95〜100%程度</td><td><strong>約210,040〜221,100円</strong></td></tr>
                <tr><td>未開封・箱なし</td><td>ラベル良好</td><td>市場相場の80〜90%程度</td><td><strong>約176,880〜198,990円</strong></td></tr>
                <tr><td>未開封・冊子なし</td><td>外箱あり</td><td>市場相場の85〜95%程度</td><td><strong>約187,940〜210,040円</strong></td></tr>
                <tr><td>未開封・ラベル軽度汚れ</td><td>付属あり</td><td>市場相場の75〜88%程度</td><td><strong>約165,820〜194,570円</strong></td></tr>
                <tr><td>未開封・ラベル損傷</td><td>付属あり</td><td>市場相場の60〜75%程度</td><td><strong>約132,660〜165,820円</strong></td></tr>
                <tr><td>未開封・液面減少</td><td>やや進行</td><td>市場相場の55〜70%程度</td><td><strong>約121,600〜154,770円</strong></td></tr>
                <tr><td>開封済み・9割以上残</td><td>付属あり</td><td>市場相場の30〜40%程度</td><td><strong>約66,330〜88,440円</strong></td></tr>
                <tr><td>開封済み・半分以下残</td><td>付属あり</td><td>市場相場の15〜25%程度</td><td><strong>約33,160〜55,280円</strong></td></tr>
              </tbody>
            </table>
          </div>
          ...
          <p>「余市20年 買取 箱無し」とお調べの方向けの目安です。未開封・箱なし（ラベル良好）の場合、業界一般の目安は<strong>市場相場の80〜90%程度（約176,880〜198,990円）</strong>。外箱・冊子の揃った完品と比べて1〜2割の減額にとどまるため、<strong>箱がなくても売却を諦める必要はありません</strong>。</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 not-prose">
            ...
            <Link href="/articles/yoichi-15-kaitori/" className="block bg-white border border-warm-border rounded-xl p-4 hover:shadow-md transition-shadow"><span className="text-xs text-amber-dark font-bold">関連銘柄</span><p className="text-sm font-bold mt-1">余市15年 の買取相場</p><p className="text-xs text-warm-gray mt-1">市場相場 80,150円</p></Link>
          </div>
