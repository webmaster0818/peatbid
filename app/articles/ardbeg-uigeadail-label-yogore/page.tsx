    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>アードベッグ ウーガダールの実勢中央値<strong>7,979円</strong>（新品同様=100%）に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 7,979円（100%）</li><li><strong>軽度の汚れ</strong>: 約7,180円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 約6,380円（80%程度）</li><li><strong>破れ・欠け</strong>: 約5,190円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 約3,990円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 約3,190円（40%程度）</li><li><strong>ラベル完全消失</strong>: 約1,600円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
