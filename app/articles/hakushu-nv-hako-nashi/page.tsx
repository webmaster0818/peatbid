    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>白州ノンエイジの場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 基準価格 10,000円（100%）</li><li><strong>箱あり・冊子なし</strong>: 8,500円〜9,500円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 8,500円〜9,200円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 8,000円〜9,000円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 7,500円〜8,500円（75〜85%）
