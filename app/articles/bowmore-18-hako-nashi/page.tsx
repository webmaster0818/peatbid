...
export const metadata: Metadata = {
  title: 'ボウモア18年が箱なしでも買取できる？【2026年最新】査定額の影響と賢い売却法',
  description: 'ボウモア18年を箱なしで売る場合の査定額への影響と、買取を依頼する際の注意点。査定額の目安、付属品代替策、賢い売却戦略を解説。',
};

function FaqSchema() {
  return <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{ "@type": "Question", "name": '箱を捨ててしまったボウモア18年でも売れる？', "acceptedAnswer": { "@type": "Answer", "text": 'はい、売れます。査定額は10〜20%下がりますが、未開封でラベル状態が良ければ十分な価格がつきます。' } }, { "@type": "Question", "name": '代用品の箱（汎用箱）を作って売却するのは？', "acceptedAnswer": { "@type": "Answer", "text": '正規品でない箱は査定額に影響しません。むしろ正規品でない外箱は混乱を招くため、添付しない方が良いです。' } }, { "@type": "Question", "name": 'ホログラムシールが箱だけにある場合は？', "acceptedAnswer": { "@type": "Answer", "text": 'ホログラムシールがボトルにも貼られている場合は問題なし。ただし、確認方法は業者により異なるため、事前に相談しましょう。' } }] }) }} />;
}
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-hibiki.png" alt='ボウモア18年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <p>「外箱を捨ててしまった」「最初から箱なしで購入した」——そんな状況でも、ボウモア18年の買取は可能です。ただし、付属品の有無で査定額は大きく変動します。本記事では、箱なしの場合の影響と賢い売却法を解説します。</p>

          <h2>箱なしによる査定額の影響</h2>

          <div dangerouslySetInnerHTML={{ __html: `<p>ボウモア18年の場合、外箱の有無で査定額が<strong>10〜20%</strong>変動します:<br/>- <strong>箱・冊子・カートン揃い</strong>: 基準価格 18,000円<br/>- <strong>箱なし、ラベル良好</strong>: 14,400円〜16,200円<br/>- <strong>箱なし、冊子なし</strong>: 13,500円〜15,300円</p>` }} />
          ...
          <div className="space-y-3 not-prose">
            {[{ q: '箱を捨ててしまったボウモア18年でも売れる？', a: 'はい、売れます。査定額は10〜20%下がりますが、未開封でラベル状態が良ければ十分な価格がつきます。' }, { q: '代用品の箱（汎用箱）を作って売却するのは？', a: '正規品でない箱は査定額に影響しません。むしろ正規品でない外箱は混乱を招くため、添付しない方が良いです。' }, { q: 'ホログラムシールが箱だけにある場合は？', a: 'ホログラムシールがボトルにも貼られている場合は問題なし。ただし、確認方法は業者により異なるため、事前に相談しましょう。' }].map((faq) => (
