...
export const metadata: Metadata = {
  title: 'マッカラン30年の希少性と買取・投資価値【2026年9月最新】保有か売却かの判断軸',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/macallan-30.png" alt='マッカラン30年の希少性と投資価値' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <p>マッカラン30年は希少度極希少クラスのボトル。直近の実勢中央値は約351,000円で、投資対象として保有すべきか、それとも売却すべきか——コレクターが直面する判断を、データと市場動向から考察します。</p>
