...
export const metadata: Metadata = {
  title: '響ジャパニーズハーモニーの偽物・贋作の見分け方【2026年6月最新】本物との違い5点（ラベル・キャップ・液面）と売却前チェック',
...
贋作と判明した場合、買取業者は買取を拒否します。また、贋作と知りながら売却することは詐欺罪に該当する可能性があるため、誠実に対処することが重要です。</li></ol>` }} />
          ...
          <div className="bg-burgundy/5 border-2 border-burgundy/30 rounded-xl p-6 my-8 not-prose">
            ...
            <p className="text-sm text-warm-gray leading-relaxed mb-4">真贋に問題がなさそうなら、価値が変わる前に今の相場を確かめておきましょう。響ジャパニーズハーモニーの実勢相場（中古中央値）は<strong className="text-ink">11,322円</strong>が目安です（当サイトのYahoo!オークション実勢集計・保証額ではありません）。次の3ステップで、納得して高く売れます。</p>
            <ol className="space-y-2 text-sm text-ink mb-4 list-none pl-0">
              <li><span className="font-bold text-burgundy">STEP 1</span>　相場を知る → <Link href="/articles/hibiki-nv-kaitori/" className="text-amber-dark underline">響ジャパニーズハーモニーの買取相場 完全ガイド</Link></li>
              <li><span className="font-bold text-burgundy">STEP 2</span>　高く売るコツ → <Link href="/articles/hibiki-nv-takaku-uru/" className="text-amber-dark underline">査定額を最大化する7つのコツ</Link></li>
