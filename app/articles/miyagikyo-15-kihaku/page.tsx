    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>宮城峡15年は希少度カテゴリで「高希少」に分類されます。希少度は (1)生産終了・休売、(2)流通量、(3)コレクター需要、(4)国際的評価 の4要素で決まります。希少度が高いほど、二次流通市場での価格上昇期待が大きくなります。</p>` }} />

          <h2>価格推移の傾向</h2>

          <div dangerouslySetInnerHTML={{ __html: `<p>宮城峡15年は過去5〜10年にわたって、二次流通市場で価格が上昇基調にあります。特に2018年以降の世界的ジャパニーズウイスキーブーム以降は、長期熟成・終売銘柄を中心に<strong>3〜10倍</strong>の値上がりを記録した銘柄も少なくありません。</p>` }} />

          <h2>投資資産としての評価</h2>

          <div dangerouslySetInnerHTML={{ __html: `<p>ウイスキーは「<strong>液体資産（Liquid Asset）</strong>」として国際的に認識されつつあります。<strong>Knight Frank Luxury Investment Index</strong>でも、ウイスキーは過去10年で最も値上がりした投資対象の1つ。宮城峡15年クラスのボトルは、保管環境さえ整えれば<strong>実物資産</strong>として機能します。</p>` }} />
