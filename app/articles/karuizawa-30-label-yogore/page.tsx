...
export const metadata: Metadata = {
  title: '軽井沢30年のラベル汚れ・破れがあっても売れる？【2026年最新】状態別の査定額目安',
  description: '軽井沢30年のラベル汚れ・破れ・剥がれ・水濡れ跡がある場合の買取査定額を解説。状態別の価格目安と、ラベルを保護する保管方法。',
};
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>長期保管した軽井沢30年のラベルが汚れた、破れた、水濡れ跡がついた——そんな場合でも、買取は可能です。本記事では、ラベルの状態が査定額にどう影響するか、状態別の価格目安を解説します。</p>
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>軽井沢30年の基準価格 800万円に対し、ラベル状態でこう変動します:<br/>- <strong>新品同様</strong>: 800万円（100%）<br/>- <strong>軽度の汚れ</strong>: 720万円（90%程度）<br/>- <strong>シミ・水濡れ跡</strong>: 640万円（80%程度）<br/>- <strong>破れ・欠け</strong>: 520万円（65%程度）<br/>- <strong>強い退色・大きな損傷</strong>: 400万円（50%程度）</p>` }} />
