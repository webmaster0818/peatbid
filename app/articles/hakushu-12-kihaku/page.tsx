    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <article className="prose">
          ...
          <p>白州12年は希少度カテゴリで「終売プレミア」に分類されます。希少度は (1)生産終了・休売、(2)流通量、(3)コレクター需要、(4)国際的評価 の4要素で決まります。希少度が高いほど、二次流通市場での価格上昇期待が大きくなります。</p>

          <h2>価格推移の傾向</h2>

          <p>白州12年は過去5〜10年にわたって、二次流通市場で価格が上昇基調にあります。特に2018年以降の世界的ジャパニーズウイスキーブーム以降は、長期熟成・終売銘柄を中心に**3〜10倍**の値上がりを記録した銘柄も少なくありません。</p>

          <h2>投資資産としての評価</h2>

          <p>ウイスキーは「**液体資産（Liquid Asset）**」として国際的に認識されつつあります。**Knight Frank Luxury Investment Index**でも、ウイスキーは過去10年で最も値上がりした投資対象の1つ。白州12年クラスのボトルは、保管環境さえ整えれば**実物資産**として機能します。</p>
