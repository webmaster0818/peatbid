    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/article-yamazaki.png" alt='白州25年のラベル汚れ・破れがあっても売れる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div className="bg-cream/40 border border-amber/30 rounded-xl p-5 mb-8 not-prose">
            ...
            <ol className="space-y-1.5 text-sm text-amber-dark">
              ...
              <li><a href="#section-1" className="hover:underline">2. ラベル状態別の査定額目安（白州25年）</a></li>
          ...
          <h2 id="section-1">2. ラベル状態別の査定額目安（白州25年）</h2>
          <div dangerouslySetInnerHTML={{ __html: `<p>白州25年の基準価格 950,000円に対し、ラベル状態でこう変動します:</p><ol><li><strong>新品同様</strong>: 950,000円（100%）</li><li><strong>軽度の汚れ</strong>: 855,000円（90%程度）</li><li><strong>シミ・水濡れ跡</strong>: 760,000円（80%程度）</li><li><strong>破れ・欠け</strong>: 617,500円（65%程度）</li><li><strong>強い退色・大きな損傷</strong>: 475,000円（50%程度）</li><li><strong>ラベル剥がれ（残あり）</strong>: 380,000円（40%程度）</li><li><strong>ラベル完全消失</strong>: 190,000円（20%程度、ヴィンテージ価値あれば例外）</li></ol>` }} />
...
どの業者も査定無料・キャンセル無料なので、3社以上で見積もり比較が鉄則です。</li></ol>` }} />
          ...
          <div className="not-prose mt-5">
            ...
            <ul className="list-disc list-inside text-sm space-y-1 text-warm-gray">
              ...
              <li><Link href="/articles/hakushu-18-label-yogore/" className="text-amber-dark hover:text-burgundy underline">白州18年のラベル汚れの査定</Link></li>
            </ul>
          </div>
