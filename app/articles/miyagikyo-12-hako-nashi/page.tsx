...
export const metadata: Metadata = {
  title: '宮城峡12年は箱なしでも買取できる?【2026年8月最新】査定額への影響と対策',
    ...
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 md:py-16">
        ...
        <div className="article-hero mb-8">
          <Image src="/images/heroes/miyagikyo-12.png" alt='宮城峡12年が箱なしでも買取できる？' width={1200} height={440} className="w-full h-[220px] object-cover rounded-xl" priority />
        ...
        <article className="prose">
          ...
          <div dangerouslySetInnerHTML={{ __html: `<p>宮城峡12年の場合、実勢中央値<strong>36,509円</strong>を基準（付属品フル揃い=100%）として、付属品の有無で査定額は次のように変動します:</p><ol><li><strong>箱・冊子・カートン揃い</strong>: 36,509円（100%）</li><li><strong>箱あり・冊子なし</strong>: 約31,030〜34,680円（85〜95%）</li><li><strong>箱なし・冊子あり</strong>: 約31,030〜33,590円（85〜92%）</li><li><strong>箱なし・ラベル良好</strong>: 約29,210〜32,860円（80〜90%）</li><li><strong>箱・冊子なし</strong>: 約27,380〜31,030円（75〜85%）

つまり付属品の有無だけで、最大で<strong>約9,130円（相場の約25%）の差</strong>が生じ得ます。</li></ol>` }} />
